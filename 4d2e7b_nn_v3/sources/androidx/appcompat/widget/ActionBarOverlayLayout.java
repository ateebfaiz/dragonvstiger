...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    private void init(Context context) {
        ...
        this.mIgnoreWindowContentOverlay = z11;
    ...
    public void draw(Canvas canvas) {
        ...
        if (this.mWindowContentOverlay != null && !this.mIgnoreWindowContentOverlay) {
            if (this.mActionBarTop.getVisibility() == 0) {
                i10 = (int) (((float) this.mActionBarTop.getBottom()) + this.mActionBarTop.getTranslationY() + 0.5f);
            } else {
                i10 = 0;
            }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        if (z10) {
            i12 = this.mActionBarHeight;
            if (this.mHasNonEmbeddedTabs && this.mActionBarTop.getTabContainer() != null) {
                i12 += this.mActionBarHeight;
            }
        } else {
            i12 = this.mActionBarTop.getVisibility() != 8 ? this.mActionBarTop.getMeasuredHeight() : 0;
        }
        ...
        if (this.mOverlayMode || z10) {
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.of(windowInsetsCompat.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + i12, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
        } else {
            Rect rect = this.mContentInsets;
            rect.top += i12;
            rect.bottom = rect.bottom;
            this.mInnerInsets = windowInsetsCompat.inset(0, i12, 0, 0);
        }
    ...
    public void setActionBarHideOffset(int i10) {
        haltActionBarHideOffsetAnimations();
        this.mActionBarTop.setTranslationY((float) (-Math.max(0, Math.min(i10, this.mActionBarTop.getHeight()))));
    }
