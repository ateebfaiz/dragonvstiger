...
public abstract class FabTransformationBehavior extends ExpandableTransformationBehavior {
    ...
    class a extends AnimatorListenerAdapter {
        ...
        public void onAnimationStart(Animator animator) {
            if (this.f8755a) {
                ...
                this.f8757c.setAlpha(0.0f);
                this.f8757c.setVisibility(4);
            }
        }
    }
    ...
    class c extends AnimatorListenerAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ CircularRevealWidget f8761a;

        /* renamed from: b  reason: collision with root package name */
        final /* synthetic */ Drawable f8762b;

        c(CircularRevealWidget circularRevealWidget, Drawable drawable) {
            this.f8761a = circularRevealWidget;
            this.f8762b = drawable;
        }

        public void onAnimationEnd(Animator animator) {
            this.f8761a.setCircularRevealOverlayDrawable((Drawable) null);
        }

        public void onAnimationStart(Animator animator) {
            this.f8761a.setCircularRevealOverlayDrawable(this.f8762b);
        }
    }
    ...
    class d extends AnimatorListenerAdapter {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ CircularRevealWidget f8764a;

        d(CircularRevealWidget circularRevealWidget) {
            this.f8764a = circularRevealWidget;
        }

        public void onAnimationEnd(Animator animator) {
            CircularRevealWidget.RevealInfo revealInfo = this.f8764a.getRevealInfo();
            revealInfo.radius = Float.MAX_VALUE;
            this.f8764a.setRevealInfo(revealInfo);
        }
    }
