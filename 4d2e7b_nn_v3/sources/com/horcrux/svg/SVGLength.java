...
class SVGLength {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f9685a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f9685a     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    private SVGLength() {
        this.f9683a = 0.0d;
        this.f9684b = UnitType.UNKNOWN;
    }

    static ArrayList a(Dynamic dynamic) {
        int i10 = a.f9685a[dynamic.getType().ordinal()];
        if (i10 != 1) {
            int i11 = 0;
            if (i10 == 2) {
