...
public class MaterialContainerTransformSharedElementCallback extends SharedElementCallback {
    ...
    class a extends i {
        ...
        public void onTransitionEnd(Transition transition) {
            MaterialContainerTransformSharedElementCallback.restoreWindowBackground(this.f8909a);
        }

        public void onTransitionStart(Transition transition) {
            MaterialContainerTransformSharedElementCallback.removeWindowBackground(this.f8909a);
        }
    }
    ...
    class b extends i {
        ...
        public void onTransitionEnd(Transition transition) {
            ...
            this.f8911a.finish();
            this.f8911a.overridePendingTransition(0, 0);
        }
    }
    ...
    class c extends i {
        ...
        public void onTransitionStart(Transition transition) {
            MaterialContainerTransformSharedElementCallback.removeWindowBackground(this.f8913a);
        }
    }
    ...
    public void onSharedElementEnd(@NonNull List<String> list, @NonNull List<View> list2, @NonNull List<View> list3) {
        ...
        if (!this.entering && !list2.isEmpty()) {
            this.returnEndBounds = j.i(list2.get(0));
        }
        this.entering = false;
    }
