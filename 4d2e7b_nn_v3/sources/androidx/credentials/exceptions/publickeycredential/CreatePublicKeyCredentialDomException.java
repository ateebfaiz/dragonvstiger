...
public final class CreatePublicKeyCredentialDomException extends CreatePublicKeyCredentialException {
    ...
    public static final class Companion {
        ...
        public final CreateCredentialException createFrom(String str, String str2) {
            ...
            try {
                ...
                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + AbortError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_ABORT_ERROR)) {
                    obj = companion.generateException(new AbortError(), str2, createPublicKeyCredentialDomException);
                } else {
                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + ConstraintError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_CONSTRAINT_ERROR)) {
                        obj = companion.generateException(new ConstraintError(), str2, createPublicKeyCredentialDomException);
                    } else {
                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + DataCloneError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DATA_CLONE_ERROR)) {
                            obj = companion.generateException(new DataCloneError(), str2, createPublicKeyCredentialDomException);
                        } else {
                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + DataError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DATA_ERROR)) {
                                obj = companion.generateException(new DataError(), str2, createPublicKeyCredentialDomException);
                            } else {
                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + EncodingError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_ENCODING_ERROR)) {
                                    obj = companion.generateException(new EncodingError(), str2, createPublicKeyCredentialDomException);
                                } else {
                                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + HierarchyRequestError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_HIERARCHY_REQUEST_ERROR)) {
                                        obj = companion.generateException(new HierarchyRequestError(), str2, createPublicKeyCredentialDomException);
                                    } else {
                                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + InUseAttributeError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_IN_USE_ATTRIBUTE_ERROR)) {
                                            obj = companion.generateException(new InUseAttributeError(), str2, createPublicKeyCredentialDomException);
                                        } else {
                                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + InvalidCharacterError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_INVALID_CHARACTER_ERROR)) {
                                                obj = companion.generateException(new InvalidCharacterError(), str2, createPublicKeyCredentialDomException);
                                            } else {
                                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + InvalidModificationError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_INVALID_MODIFICATION_ERROR)) {
                                                    obj = companion.generateException(new InvalidModificationError(), str2, createPublicKeyCredentialDomException);
                                                } else {
                                                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + InvalidNodeTypeError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_INVALID_NODE_TYPE_ERROR)) {
                                                        obj = companion.generateException(new InvalidNodeTypeError(), str2, createPublicKeyCredentialDomException);
                                                    } else {
                                                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + InvalidStateError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_INVALID_STATE_ERROR)) {
                                                            obj = companion.generateException(new InvalidStateError(), str2, createPublicKeyCredentialDomException);
                                                        } else {
                                                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NamespaceError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NAMESPACE_ERROR)) {
                                                                obj = companion.generateException(new NamespaceError(), str2, createPublicKeyCredentialDomException);
                                                            } else {
                                                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NetworkError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NETWORK_ERROR)) {
                                                                    obj = companion.generateException(new NetworkError(), str2, createPublicKeyCredentialDomException);
                                                                } else {
                                                                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NoModificationAllowedError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NO_MODIFICATION_ALLOWED_ERROR)) {
                                                                        obj = companion.generateException(new NoModificationAllowedError(), str2, createPublicKeyCredentialDomException);
                                                                    } else {
                                                                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NotAllowedError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NOT_ALLOWED_ERROR)) {
                                                                            obj = companion.generateException(new NotAllowedError(), str2, createPublicKeyCredentialDomException);
                                                                        } else {
                                                                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NotFoundError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NOT_FOUND_ERROR)) {
                                                                                obj = companion.generateException(new NotFoundError(), str2, createPublicKeyCredentialDomException);
                                                                            } else {
                                                                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NotReadableError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NOT_READABLE_ERROR)) {
                                                                                    obj = companion.generateException(new NotReadableError(), str2, createPublicKeyCredentialDomException);
                                                                                } else {
                                                                                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + NotSupportedError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NOT_SUPPORTED_ERROR)) {
                                                                                        obj = companion.generateException(new NotSupportedError(), str2, createPublicKeyCredentialDomException);
                                                                                    } else {
                                                                                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + OperationError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_OPERATION_ERROR)) {
                                                                                            obj = companion.generateException(new OperationError(), str2, createPublicKeyCredentialDomException);
                                                                                        } else {
                                                                                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + OptOutError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_OPT_OUT_ERROR)) {
                                                                                                obj = companion.generateException(new OptOutError(), str2, createPublicKeyCredentialDomException);
                                                                                            } else {
                                                                                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + QuotaExceededError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_QUOTA_EXCEEDED_ERROR)) {
                                                                                                    obj = companion.generateException(new QuotaExceededError(), str2, createPublicKeyCredentialDomException);
                                                                                                } else {
                                                                                                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + ReadOnlyError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_READ_ONLY_ERROR)) {
                                                                                                        obj = companion.generateException(new ReadOnlyError(), str2, createPublicKeyCredentialDomException);
                                                                                                    } else {
                                                                                                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + SecurityError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_SECURITY_ERROR)) {
                                                                                                            obj = companion.generateException(new SecurityError(), str2, createPublicKeyCredentialDomException);
                                                                                                        } else {
                                                                                                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + SyntaxError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_SYNTAX_ERROR)) {
                                                                                                                obj = companion.generateException(new SyntaxError(), str2, createPublicKeyCredentialDomException);
                                                                                                            } else {
                                                                                                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + TimeoutError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_TIMEOUT_ERROR)) {
                                                                                                                    obj = companion.generateException(new TimeoutError(), str2, createPublicKeyCredentialDomException);
                                                                                                                } else {
                                                                                                                    if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + TransactionInactiveError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_TRANSACTION_INACTIVE_ERROR)) {
                                                                                                                        obj = companion.generateException(new TransactionInactiveError(), str2, createPublicKeyCredentialDomException);
                                                                                                                    } else {
                                                                                                                        if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + UnknownError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_UNKNOWN_ERROR)) {
                                                                                                                            obj = companion.generateException(new UnknownError(), str2, createPublicKeyCredentialDomException);
                                                                                                                        } else {
                                                                                                                            if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + VersionError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_VERSION_ERROR)) {
                                                                                                                                obj = companion.generateException(new VersionError(), str2, createPublicKeyCredentialDomException);
                                                                                                                            } else {
                                                                                                                                if (m.b(str, "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/" + WrongDocumentError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_WRONG_DOCUMENT_ERROR)) {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ CreatePublicKeyCredentialDomException(DomError domError2, CharSequence charSequence, int i10, DefaultConstructorMarker defaultConstructorMarker) {
