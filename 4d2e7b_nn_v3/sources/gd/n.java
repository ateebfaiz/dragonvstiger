...
public class n extends f.b {
    ...
    public f a(f fVar) {
        ...
        if (!jd.d.j(c13)) {
            ...
            return new n(g10, mVar7, mVar8, new d[]{mVar9}, this.f158e);
        } else if (jd.d.j(c10)) {
            return w();
        } else {
            return g10.q();
    ...
    public f r() {
        ...
        return new n(this.f154a, this.f155b, this.f156c.l(), this.f157d, this.f158e);
    }
    ...
    public f w() {
        ...
        l.i(c12, c13);
        boolean g11 = mVar3.g();
        int[] iArr = mVar3.f291g;
        if (!g11) {
            l.i(iArr, c11);
            iArr = c11;
        }
        l.k(mVar2.f291g, iArr, c10);
        l.a(mVar2.f291g, iArr, c11);
        l.d(c11, c10, c11);
        l.h(jd.d.b(c11, c11, c11), c11);
        l.d(c12, mVar2.f291g, c12);
        l.h(m.F(5, c12, 2, 0), c12);
        l.h(m.G(5, c13, 3, 0, c10), c10);
        m mVar4 = new m(c13);
        l.i(c11, mVar4.f291g);
        int[] iArr2 = mVar4.f291g;
        l.k(iArr2, c12, iArr2);
        int[] iArr3 = mVar4.f291g;
        l.k(iArr3, c12, iArr3);
        m mVar5 = new m(c12);
        l.k(c12, mVar4.f291g, mVar5.f291g);
        int[] iArr4 = mVar5.f291g;
        l.d(iArr4, c11, iArr4);
        int[] iArr5 = mVar5.f291g;
        l.k(iArr5, c10, iArr5);
        m mVar6 = new m(c11);
        l.l(mVar.f291g, mVar6.f291g);
        if (!g11) {
            int[] iArr6 = mVar6.f291g;
            l.d(iArr6, mVar3.f291g, iArr6);
        }
        return new n(g10, mVar4, mVar5, new d[]{mVar6}, this.f158e);
    }

    public n(c cVar, d dVar, d dVar2, boolean z10) {
    ...
    n(c cVar, d dVar, d dVar2, d[] dVarArr, boolean z10) {
