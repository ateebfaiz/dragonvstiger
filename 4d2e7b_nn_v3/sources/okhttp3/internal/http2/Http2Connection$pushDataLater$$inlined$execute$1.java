...
public final class Http2Connection$pushDataLater$$inlined$execute$1 extends Task {
    ...
    public Http2Connection$pushDataLater$$inlined$execute$1(String str, boolean z10, String str2, boolean z11, Http2Connection http2Connection, int i10, Buffer buffer, int i11, boolean z12) {
        super(str2, z11);
        this.$name = str;
        this.$cancelable = z10;
