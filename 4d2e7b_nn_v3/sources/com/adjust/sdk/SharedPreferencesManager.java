...
public class SharedPreferencesManager {
    ...
    private synchronized int getRawReferrerIndex(java.lang.String r8, long r9) {
        /*
            r7 = this;
            monitor-enter(r7)
            org.json.JSONArray r0 = r7.getRawReferrerArray()     // Catch:{ JSONException -> 0x0034, all -> 0x002d }
            r1 = 0
            r2 = r1
        L_0x0007:
            int r3 = r0.length()     // Catch:{ JSONException -> 0x0034, all -> 0x002d }
            if (r2 >= r3) goto L_0x0034
            org.json.JSONArray r3 = r0.getJSONArray(r2)     // Catch:{ JSONException -> 0x0034, all -> 0x002d }
            r4 = 0
            java.lang.String r4 = r3.optString(r1, r4)     // Catch:{ JSONException -> 0x0034, all -> 0x002d }
            if (r4 == 0) goto L_0x002f
            boolean r4 = r4.equals(r8)     // Catch:{ JSONException -> 0x0034, all -> 0x002d }
            if (r4 != 0) goto L_0x001f
            goto L_0x002f
        L_0x001f:
            r4 = -1
            r6 = 1
            long r3 = r3.optLong(r6, r4)     // Catch:{ JSONException -> 0x0034, all -> 0x002d }
