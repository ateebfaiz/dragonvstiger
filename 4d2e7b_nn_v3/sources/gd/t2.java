...
public class t2 extends f.a {
    public t2(c cVar, d dVar, d dVar2) {
        ...
        if (!r2Var4.h()) {
            ...
            if (!l.f(a13)) {
                if (r2Var5.h()) {
                    ...
                    r2 r2Var11 = (r2) d10.n().a(d10).a(r2Var10);
                    if (r2Var11.h()) {
                        return new t2(g10, r2Var11, g10.l(), this.f158e);
                    }
                    ...
                    if (r2Var12.h()) {
                        return new t2(g10, r2Var12, g10.l(), this.f158e);
                    }
                ...
                return new t2(g10, r2Var2, r2Var, new d[]{r2Var3}, this.f158e);
            } else if (l.f(a12)) {
                return w();
            } else {
                return g10.q();
    ...
    public f r() {
        ...
        d dVar2 = this.f156c;
        d dVar3 = this.f157d[0];
        return new t2(this.f154a, dVar, dVar2.a(dVar3), new d[]{dVar3}, this.f158e);
    }
    ...
    public f w() {
        ...
        if (g11) {
            dVar2 = dVar5.n().a(dVar5);
        } else {
            dVar2 = dVar5.a(dVar6).i(dVar5);
        }
        if (dVar2.h()) {
            return new t2(g10, dVar2, g10.l(), this.f158e);
        }
        d n10 = dVar2.n();
        if (g11) {
            dVar3 = dVar2;
        ...
        d n11 = dVar5.a(dVar4).n();
        if (!g11) {
            dVar6 = dVar.n();
        }
        d a10 = n11.a(dVar2).a(dVar).i(n11).a(dVar6).a(n10).a(dVar3);
        return new t2(g10, n10, a10, new d[]{dVar3}, this.f158e);
    }

    public t2(c cVar, d dVar, d dVar2, boolean z10) {
    ...
    t2(c cVar, d dVar, d dVar2, d[] dVarArr, boolean z10) {
