...
public interface c extends IInterface {
    ...
    public static abstract class a extends Binder implements c {
        ...
        private static class C0361a implements c {

            /* renamed from: a  reason: collision with root package name */
            private IBinder f24968a;

            C0361a(IBinder iBinder) {
                this.f24968a = iBinder;
            }
            ...
            public void h(a aVar, String str, Bundle bundle) {
                IBinder iBinder;
                ...
                try {
                    ...
                    this.f24968a.transact(3, obtain, obtain2, 0);
            ...
            public void o(a aVar, Bundle bundle) {
                IBinder iBinder;
                Parcel obtain = Parcel.obtain();
                Parcel obtain2 = Parcel.obtain();
                try {
                    ...
                    this.f24968a.transact(2, obtain, obtain2, 0);
                    obtain2.readException();
                    obtain2.recycle();
                    obtain.recycle();
                } catch (Throwable th) {
        ...
        public boolean onTransact(int r5, android.os.Parcel r6, android.os.Parcel r7, int r8) {
            ...
            L_0x0057:
                ...
                return r2
            */
            throw new UnsupportedOperationException("Method not decompiled: z.c.a.onTransact(int, android.os.Parcel, android.os.Parcel, int):boolean");
        }
    }

    void h(a aVar, String str, Bundle bundle);
