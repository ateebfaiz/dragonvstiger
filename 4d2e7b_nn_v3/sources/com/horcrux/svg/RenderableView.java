...
public abstract class RenderableView extends VirtualView implements c {
    ...
    static /* synthetic */ class a {
        ...
        static {
            /*
                com.horcrux.svg.s[] r0 = com.horcrux.svg.s.values()
                int r0 = r0.length
                int[] r0 = new int[r0]
                f9681a = r0
                com.horcrux.svg.s r1 = com.horcrux.svg.s.kStartMarker     // Catch:{ NoSuchFieldError -> 0x0012 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0012 }
            L_0x0012:
                int[] r0 = f9681a     // Catch:{ NoSuchFieldError -> 0x001d }
                com.horcrux.svg.s r1 = com.horcrux.svg.s.kMidMarker     // Catch:{ NoSuchFieldError -> 0x001d }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x001d }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x001d }
            L_0x001d:
                int[] r0 = f9681a     // Catch:{ NoSuchFieldError -> 0x0028 }
                com.horcrux.svg.s r1 = com.horcrux.svg.s.kEndMarker     // Catch:{ NoSuchFieldError -> 0x0028 }
    ...
    private void setupPaint(Paint paint, float f10, ReadableArray readableArray) {
        ...
        if (i11 != 0) {
            if (i11 == 1) {
                ...
                paint.setColor((Math.round(((float) (currentColor >>> 24)) * f10) << 24) | (currentColor & ViewCompat.MEASURED_SIZE_MASK));
            } else if (i11 == 3) {
    ...
    public Rect getHitSlopRect() {
        if (this.mPointerEvents == h0.BOX_NONE) {
    ...
    public int hitTest(float[] fArr) {
        Region region;
        Region region2;
        if (this.mPath == null || !this.mInvertible || this.mPointerEvents == h0.NONE) {
            return -1;
        }
    ...
    public void render(Canvas canvas, Paint paint, float f10) {
        ...
        RectF rectF;
        if (this.mMask != null) {
            maskView = (MaskView) getSvgView().getDefinedMask(this.mMask);
        } else {
            maskView = null;
        }
        if (this.mFilter != null) {
            filterView = (FilterView) getSvgView().getDefinedFilter(this.mFilter);
        } else {
            filterView = null;
        }
        ...
        if (filterView != null) {
            ...
            if (!(this instanceof ImageView) || clientRect != null) {
                Bitmap p10 = filterView.p(createBitmap, currentBitmap, clientRect);
        ...
        if (maskView != null) {
            ...
            if (maskView.A() == MaskView.a.LUMINANCE) {
            ...
            if (maskView.B() == a.b.USER_SPACE_ON_USE) {
                float relativeOnWidth = (float) relativeOnWidth(maskView.f9649f);
                float relativeOnHeight = (float) relativeOnHeight(maskView.f9650g);
                rectF = new RectF(relativeOnWidth, relativeOnHeight, ((float) relativeOnWidth(maskView.f9651h)) + relativeOnWidth, ((float) relativeOnHeight(maskView.f9652i)) + relativeOnHeight);
            } else {
                RectF clientRect2 = getClientRect();
                if (!(this instanceof ImageView) || clientRect2 != null) {
                    this.mInvCTM.mapRect(clientRect2);
                    float relativeOnFraction = (float) relativeOnFraction(maskView.f9649f, clientRect2.width());
                    float relativeOnFraction2 = (float) relativeOnFraction(maskView.f9650g, clientRect2.height());
                    float f11 = clientRect2.left;
                    float f12 = clientRect2.top;
                    rectF = new RectF(f11 + relativeOnFraction, f12 + relativeOnFraction2, f11 + relativeOnFraction + ((float) relativeOnFraction(maskView.f9651h, clientRect2.width())), f12 + relativeOnFraction2 + ((float) relativeOnFraction(maskView.f9652i, clientRect2.height())));
                } else {
                    return;
                }
            }
    ...
    public void renderMarkers(Canvas canvas, Paint paint, float f10) {
        ...
        ArrayList<m> arrayList = this.elements;
        if (arrayList == null) {
            return;
        }
        if (markerView2 != null || markerView3 != null || markerView4 != null) {
            ...
            while (it.hasNext()) {
                q qVar = (q) it.next();
                int i10 = a.f9681a[qVar.f9933a.ordinal()];
                if (i10 == 1) {
                ...
                if (markerView != null) {
                    markerView.A(canvas, paint, f10, qVar, f11);
                    this.mMarkerPath.addPath(markerView.getPath(canvas, paint), markerView.S0);
                }
            }
            contextElement = null;
        }
