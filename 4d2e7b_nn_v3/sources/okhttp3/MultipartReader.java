...
public final class MultipartReader implements Closeable {
    ...
    private final class PartSource implements Source {
        ...
        public void close() {
            if (m.b(MultipartReader.this.currentPart, this)) {
        ...
        public long read(Buffer buffer, long j10) {
            ...
            if (!z10) {
            ...
            } else if (m.b(MultipartReader.this.currentPart, this)) {
                ...
                if (timeout2.hasDeadline()) {
                    ...
                    try {
                        long access$currentPartBytesRemaining = MultipartReader.this.currentPartBytesRemaining(j13);
                        if (access$currentPartBytesRemaining == 0) {
                            j12 = -1;
                        } else {
                            j12 = MultipartReader.this.source.read(buffer2, access$currentPartBytesRemaining);
                        }
                    ...
                    try {
                        long access$currentPartBytesRemaining2 = MultipartReader.this.currentPartBytesRemaining(j13);
                        if (access$currentPartBytesRemaining2 == 0) {
                            j11 = -1;
                        } else {
                            j11 = MultipartReader.this.source.read(buffer2, access$currentPartBytesRemaining2);
                        }
                        timeout2.timeout(timeoutNanos, timeUnit);
                        if (timeout3.hasDeadline()) {
    ...
    public final long currentPartBytesRemaining(long j10) {
        ...
        if (indexOf == -1) {
            return Math.min(j10, (this.source.getBuffer().size() - ((long) this.crlfDashDashBoundary.size())) + 1);
        }
