...
class GifFrameLoader {
    ...
    static class DelayTarget extends CustomTarget<Bitmap> {
        ...
        DelayTarget(Handler handler2, int i10, long j10) {
    ...
    GifFrameLoader(Glide glide, GifDecoder gifDecoder2, int i10, int i11, Transformation<Bitmap> transformation2, Bitmap bitmap) {
