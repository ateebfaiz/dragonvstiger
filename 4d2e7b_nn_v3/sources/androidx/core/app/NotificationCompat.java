...
public class NotificationCompat {
    ...
    public static class Action {
        ...
        public static final class Builder {
            ...
            public static Builder fromAndroidAction(@NonNull Notification.Action action) {
                Builder builder;
                if (b.a(action) != null) {
                    builder = new Builder(IconCompat.createFromIconOrNullIfZeroResId(b.a(action)), action.title, action.actionIntent);
                } else {
                    builder = new Builder(action.icon, action.title, action.actionIntent);
                }
                RemoteInput[] b10 = a.b(action);
                if (!(b10 == null || b10.length == 0)) {
                    for (RemoteInput fromPlatform : b10) {
            ...
            public Builder(int i10, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
                this(i10 != 0 ? IconCompat.createWithResource((Resources) null, "", i10) : null, charSequence, pendingIntent, new Bundle(), (RemoteInput[]) null, true, 0, true, false, false);
            }
        ...
        public Action(int i10, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent) {
            this(i10 != 0 ? IconCompat.createWithResource((Resources) null, "", i10) : null, charSequence, pendingIntent);
        }
        ...
        public IconCompat getIconCompat() {
            ...
            if (this.mIcon == null && (i10 = this.icon) != 0) {
                this.mIcon = IconCompat.createWithResource((Resources) null, "", i10);
            }
            return this.mIcon;
        }
        ...
        /* JADX INFO: this call moved to the top of the method (can break code semantics) */
        Action(int i10, @Nullable CharSequence charSequence, @Nullable PendingIntent pendingIntent, @Nullable Bundle bundle, @Nullable RemoteInput[] remoteInputArr, @Nullable RemoteInput[] remoteInputArr2, boolean z10, int i11, boolean z11, boolean z12, boolean z13) {
            this(i10 != 0 ? IconCompat.createWithResource((Resources) null, "", i10) : null, charSequence, pendingIntent, bundle, remoteInputArr, remoteInputArr2, z10, i11, z11, z12, z13);
        }
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (iconCompat != null) {
                if (Build.VERSION.SDK_INT >= 31) {
                    if (notificationBuilderWithBuilderAccessor instanceof p) {
                        context = ((p) notificationBuilderWithBuilderAccessor).e();
                    } else {
                        context = null;
                    }
                    b.a(bigContentTitle, this.mPictureIcon.toIcon(context));
            ...
            if (this.mBigLargeIconSet) {
                if (this.mBigLargeIcon == null) {
                    ...
                    if (notificationBuilderWithBuilderAccessor instanceof p) {
                        context2 = ((p) notificationBuilderWithBuilderAccessor).e();
                    }
                    a.a(bigContentTitle, this.mBigLargeIcon.toIcon(context2));
                }
            }
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context, @NonNull Notification notification) {
            ...
            if (a10 != null) {
                this.mLargeIcon = IconCompat.createFromIcon(a10);
            }
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (it.hasNext()) {
                    addPerson(Person.fromAndroidPerson(k.a(it.next())));
                }
            }
            int i10 = Build.VERSION.SDK_INT;
        ...
        public RemoteViews createBigContentView() {
            ...
            p pVar = new p(this);
            Style style = this.mStyle;
            if (style != null && (makeBigContentView = style.makeBigContentView(pVar)) != null) {
                return makeBigContentView;
            }
            Notification b10 = pVar.b();
            if (Build.VERSION.SDK_INT >= 24) {
                return c.a(c.d(this.mContext, b10));
            }
        ...
        public RemoteViews createContentView() {
            ...
            p pVar = new p(this);
            Style style = this.mStyle;
            if (style != null && (makeContentView = style.makeContentView(pVar)) != null) {
                return makeContentView;
            }
            Notification b10 = pVar.b();
            if (Build.VERSION.SDK_INT >= 24) {
                return c.b(c.d(this.mContext, b10));
            }
        ...
        public RemoteViews createHeadsUpContentView() {
            ...
            p pVar = new p(this);
            Style style = this.mStyle;
            if (style != null && (makeHeadsUpContentView = style.makeHeadsUpContentView(pVar)) != null) {
                return makeHeadsUpContentView;
            }
            Notification b10 = pVar.b();
            if (i10 >= 24) {
                return c.c(c.d(this.mContext, b10));
            }
    ...
    public static class CallStyle extends Style {
        ...
        private Action makeAction(int i10, int i11, Integer num, int i12, PendingIntent pendingIntent) {
            ...
            spannableStringBuilder.append(this.mBuilder.mContext.getResources().getString(i11));
            spannableStringBuilder.setSpan(new ForegroundColorSpan(num.intValue()), 0, spannableStringBuilder.length(), 18);
            Action build = new Action.Builder(IconCompat.createWithResource(this.mBuilder.mContext, i10), (CharSequence) spannableStringBuilder, pendingIntent).build();
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i10 >= 31) {
                ...
                if (i11 == 1) {
                    callStyle = d.a(this.mPerson.toAndroidPerson(), this.mDeclineIntent, this.mAnswerIntent);
                } else if (i11 == 2) {
                    callStyle = d.b(this.mPerson.toAndroidPerson(), this.mHangUpIntent);
                } else if (i11 == 3) {
                    callStyle = d.c(this.mPerson.toAndroidPerson(), this.mHangUpIntent, this.mAnswerIntent);
                ...
                if (callStyle != null) {
                    ...
                    d.i(callStyle, this.mVerificationText);
                    IconCompat iconCompat = this.mVerificationIcon;
                    if (iconCompat != null) {
                        d.h(callStyle, iconCompat.toIcon(this.mBuilder.mContext));
                    }
                    d.g(callStyle, this.mIsVideo);
                    return;
                }
                return;
            }
            ...
            if (person2 != null) {
                if (person2.getIcon() != null) {
                    b.c(builder, this.mPerson.getIcon().toIcon(this.mBuilder.mContext));
                }
                if (i10 >= 28) {
                    c.a(builder, this.mPerson.toAndroidPerson());
                } else {
                    a.a(builder, this.mPerson.getUri());
                }
            }
        ...
        public void restoreFromCompatExtras(@NonNull Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(k.a(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static abstract class Style {
        ...
        public android.widget.RemoteViews applyStandardTemplate(boolean r13, int r14, boolean r15) {
            ...
            L_0x013d:
                ...
                androidx.core.app.NotificationCompat.Style.a.a(r7, r14, r15)
                goto L_0x0196
            L_0x0182:
    ...
    public static final class WearableExtender implements Extender {
        ...
        private static Notification.Action getActionFromActionCompat(Action action) {
            ...
            Notification.Action.Builder a10 = b.a(icon, action.getTitle(), action.getActionIntent());
            ...
            if (i10 >= 24) {
                c.a(a10, action.getAllowGeneratedReplies());
            }
            if (i10 >= 31) {
                d.a(a10, action.isAuthenticationRequired());
            }
            a.a(a10, bundle);
            RemoteInput[] remoteInputs = action.getRemoteInputs();
            if (remoteInputs != null) {
                for (RemoteInput b10 : RemoteInput.fromCompat(remoteInputs)) {
                    a.b(a10, b10);
                }
            }
            return a.c(a10);
    ...
    static Action getActionCompatFromAction(@NonNull Notification.Action action) {
        ...
        if (g10 == null) {
            ...
            for (int i13 = 0; i13 < g10.length; i13++) {
                ...
                String h10 = b.h(remoteInput);
                CharSequence f10 = b.f(remoteInput);
                CharSequence[] b10 = b.b(remoteInput);
                boolean a10 = b.a(remoteInput);
                if (Build.VERSION.SDK_INT >= 29) {
                    i12 = g.c(remoteInput);
                } else {
                    i12 = 0;
                }
                remoteInputArr2[i13] = new RemoteInput(h10, f10, b10, a10, i12, b.d(remoteInput), (Set<String>) null);
            }
            remoteInputArr = remoteInputArr2;
        }
        int i14 = Build.VERSION.SDK_INT;
        if (i14 < 24) {
            z10 = b.c(action).getBoolean("android.support.allowGeneratedReplies");
        } else if (b.c(action).getBoolean("android.support.allowGeneratedReplies") || d.a(action)) {
            z10 = true;
        } else {
            z10 = false;
        }
        boolean z13 = z10;
        boolean z14 = b.c(action).getBoolean("android.support.action.showsUserInterface", true);
        if (i14 >= 28) {
            i10 = f.a(action);
        } else {
            i10 = b.c(action).getInt("android.support.action.semanticAction", 0);
        }
        int i15 = i10;
        if (i14 >= 29) {
            z11 = g.e(action);
        ...
        boolean z15 = z12;
        if (c.a(action) == null && (i11 = action2.icon) != 0) {
            return new Action(i11, action2.title, action2.actionIntent, b.c(action), remoteInputArr, (RemoteInput[]) null, z13, i15, z14, z11, z15);
        }
        if (c.a(action) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(c.a(action));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, b.c(action), remoteInputArr, (RemoteInput[]) null, z13, i15, z14, z11, z15);
    }
    ...
    public static List<Person> getPeople(@NonNull Notification notification) {
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                Iterator it = parcelableArrayList.iterator();
                while (it.hasNext()) {
                    arrayList.add(Person.fromAndroidPerson(k.a(it.next())));
                }
            }
        } else {
    ...
    public static final class CarExtender implements Extender {
        ...
        private static Bundle getBundleForUnreadConversation(@NonNull UnreadConversation unreadConversation) {
            ...
            if (remoteInput != null) {
                RemoteInput.Builder d10 = a.d(remoteInput.getResultKey());
                a.l(d10, remoteInput.getLabel());
                a.k(d10, remoteInput.getChoices());
                a.j(d10, remoteInput.getAllowFreeFormInput());
                a.a(d10, remoteInput.getExtras());
                bundle.putParcelable(KEY_REMOTE_INPUT, a.c(a.b(d10)));
            }
        ...
        private static UnreadConversation getUnreadConversationFromBundle(@Nullable Bundle bundle) {
            ...
            if (remoteInput2 != null) {
                String i12 = a.i(remoteInput2);
                CharSequence h10 = a.h(remoteInput2);
                CharSequence[] f10 = a.f(remoteInput2);
                boolean e10 = a.e(remoteInput2);
                if (Build.VERSION.SDK_INT >= 29) {
                    i10 = b.a(remoteInput2);
                }
                remoteInput = new RemoteInput(i12, h10, f10, e10, i10, a.g(remoteInput2), (Set<String>) null);
            }
    ...
    public static class MessagingStyle extends Style {
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            if (i10 >= 24) {
                if (i10 >= 28) {
                    messagingStyle = c.a(this.mUser.toAndroidPerson());
                } else {
                    messagingStyle = a.b(this.mUser.getName());
                }
                for (Message androidMessage : this.mMessages) {
                    a.a(m.a(messagingStyle), androidMessage.toAndroidMessage());
                }
                if (Build.VERSION.SDK_INT >= 26) {
                    for (Message androidMessage2 : this.mHistoricMessages) {
                        b.a(m.a(messagingStyle), androidMessage2.toAndroidMessage());
                    }
                }
                if (this.mIsGroupConversation.booleanValue() || Build.VERSION.SDK_INT >= 28) {
                    a.c(m.a(messagingStyle), this.mConversationTitle);
                }
                if (Build.VERSION.SDK_INT >= 28) {
                    c.b(m.a(messagingStyle), this.mIsGroupConversation.booleanValue());
                }
        ...
        public static final class Message {
                    ...
                    if (bundle.containsKey(KEY_TEXT)) {
                        if (bundle.containsKey(KEY_TIMESTAMP)) {
                            if (bundle.containsKey(KEY_PERSON)) {
                                ...
                                person = Person.fromAndroidPerson(k.a(bundle.getParcelable(KEY_NOTIFICATION_PERSON)));
            ...
            private Bundle toBundle() {
                ...
                if (person != null) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        bundle.putParcelable(KEY_NOTIFICATION_PERSON, b.a(this.mPerson.toAndroidPerson()));
                    } else {
            ...
            public android.app.Notification.MessagingStyle.Message toAndroidMessage() {
                ...
                L_0x001a:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat.MessagingStyle.Message.b.b(r1, r4, r3)
                    goto L_0x0032
                L_0x001f:
                    java.lang.CharSequence r1 = r6.getText()
                    long r4 = r6.getTimestamp()
                ...
                L_0x002e:
                    android.app.Notification$MessagingStyle$Message r0 = androidx.core.app.NotificationCompat.MessagingStyle.Message.a.a(r1, r4, r3)
                L_0x0032:
                    java.lang.String r1 = r6.getDataMimeType()
                    if (r1 == 0) goto L_0x0043
                    java.lang.String r1 = r6.getDataMimeType()
                    android.net.Uri r2 = r6.getDataUri()
                    androidx.core.app.NotificationCompat.MessagingStyle.Message.a.b(r0, r1, r2)
                L_0x0043:
                    return r0
                */
