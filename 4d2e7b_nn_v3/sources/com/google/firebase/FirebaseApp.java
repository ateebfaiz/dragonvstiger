...
public class FirebaseApp {
    ...
    private static class a implements BackgroundDetector.BackgroundStateChangeListener {
        ...
        private static AtomicReference f8958a = new AtomicReference();
        ...
        public static void b(Context context) {
            if (PlatformVersion.isAtLeastIceCreamSandwich() && (context.getApplicationContext() instanceof Application)) {
                ...
                if (f8958a.get() == null) {
                    a aVar = new a();
                    if (d.a.a(f8958a, (Object) null, aVar)) {
    ...
    private static class b extends BroadcastReceiver {
        ...
        private static AtomicReference f8959b = new AtomicReference();
        ...
        public static void b(Context context) {
            if (f8959b.get() == null) {
                ...
                if (d.a.a(f8959b, (Object) null, bVar)) {
        ...
        public void c() {
            this.f8960a.unregisterReceiver(this);
        }
