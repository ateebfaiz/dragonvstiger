...
public class ParserConfig {
    ...
    public Class<?> checkAutoType(String str, Class<?> cls, int i10) {
        ...
        if (str.length() < 128) {
            int i11 = 3;
            if (str.length() >= 3) {
                long charAt = (((long) str2.charAt(0)) ^ -3750763034362895579L) * 1099511628211L;
                if (charAt == -5808493101479473382L) {
                    throw new JSONException("autoType is not support. " + str2);
                } else if ((charAt ^ ((long) str2.charAt(str.length() - 1))) * 1099511628211L != 655701488918567152L) {
                    long charAt2 = (((((((long) str2.charAt(0)) ^ -3750763034362895579L) * 1099511628211L) ^ ((long) str2.charAt(1))) * 1099511628211L) ^ ((long) str2.charAt(2))) * 1099511628211L;
                    while (i11 < str.length()) {
                        charAt2 = (charAt2 ^ ((long) str2.charAt(i11))) * 1099511628211L;
                    ...
                    Class<?> findClass = this.deserializers.findClass(str2);
                    if (findClass != null) {
                        return findClass;
                    }
                    Class<?> loadClass = TypeUtils.loadClass(str2, this.defaultClassLoader, false);
                    if (loadClass == null || cls2 == null || loadClass == HashMap.class) {
                        if (loadClass.isAnnotationPresent(JSONType.class)) {
                            TypeUtils.addMapping(str2, loadClass);
                            return loadClass;
                        }
                        ...
                        TypeUtils.addMapping(str2, loadClass);
                        return loadClass;
                    } else if (cls2.isAssignableFrom(loadClass)) {
                        TypeUtils.addMapping(str2, loadClass);
                        return loadClass;
                    } else {
    ...
    public ObjectDeserializer getDeserializer(Class<?> cls, Type type) {
        ...
        } else if (cls == Set.class || cls == HashSet.class || cls == (cls2 = Collection.class) || cls == List.class || cls == ArrayList.class) {
