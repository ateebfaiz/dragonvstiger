...
public class AuthenticatorSelectionCriteria extends AbstractSafeParcelable {
    ...
    AuthenticatorSelectionCriteria(@SafeParcelable.Param(id = 2) @Nullable String str, @SafeParcelable.Param(id = 3) @Nullable Boolean bool, @SafeParcelable.Param(id = 4) @Nullable String str2, @SafeParcelable.Param(id = 5) @Nullable String str3) {
