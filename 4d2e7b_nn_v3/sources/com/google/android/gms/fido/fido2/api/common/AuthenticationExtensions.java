...
public class AuthenticationExtensions extends AbstractSafeParcelable {
    ...
    AuthenticationExtensions(@SafeParcelable.Param(id = 2) @Nullable FidoAppIdExtension fidoAppIdExtension, @SafeParcelable.Param(id = 3) @Nullable zzs zzs, @SafeParcelable.Param(id = 4) @Nullable UserVerificationMethodExtension userVerificationMethodExtension, @SafeParcelable.Param(id = 5) @Nullable zzz zzz, @SafeParcelable.Param(id = 6) @Nullable zzab zzab, @SafeParcelable.Param(id = 7) @Nullable zzad zzad, @SafeParcelable.Param(id = 8) @Nullable zzu zzu, @SafeParcelable.Param(id = 9) @Nullable zzag zzag, @SafeParcelable.Param(id = 10) @Nullable GoogleThirdPartyPaymentExtension googleThirdPartyPaymentExtension, @SafeParcelable.Param(id = 11) @Nullable zzai zzai) {
        this.zza = fidoAppIdExtension;
