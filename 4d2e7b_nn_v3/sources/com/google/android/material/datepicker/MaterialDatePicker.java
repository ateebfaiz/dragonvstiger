...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    class c implements OnApplyWindowInsetsListener {
        ...
        public WindowInsetsCompat onApplyWindowInsets(View view, WindowInsetsCompat windowInsetsCompat) {
            ...
            if (this.f8142a >= 0) {
                this.f8143b.getLayoutParams().height = this.f8142a + i10;
                View view2 = this.f8143b;
                view2.setLayoutParams(view2.getLayoutParams());
            }
            View view3 = this.f8143b;
            view3.setPadding(view3.getPaddingLeft(), this.f8144c + i10, this.f8143b.getPaddingRight(), this.f8143b.getPaddingBottom());
            return windowInsetsCompat;
        }
    }

    class d extends OnSelectionChangedListener {
        d() {
        }
    ...
    public void startPickerFragment() {
        ...
        if (this.headerToggleButton.isChecked()) {
            gVar = MaterialTextInputPicker.newInstance(getDateSelector(), themeResId, this.calendarConstraints);
        } else {
            gVar = this.calendar;
        }
        this.pickerFragment = gVar;
        updateHeader();
    ...
    public static long thisMonthInUtcMilliseconds() {
        return Month.d().f8154f;
    }

    public static long todayInUtcMilliseconds() {
        return k.o().getTimeInMillis();
    }
    ...
    public final void onSaveInstanceState(@NonNull Bundle bundle) {
        ...
        if (this.calendar.getCurrentMonth() != null) {
            builder.setOpenAt(this.calendar.getCurrentMonth().f8154f);
        }
    ...
    public static final class Builder<S> {
        ...
        private Month createDefaultOpenAt() {
            if (!this.dateSelector.getSelectedDays().isEmpty()) {
                Month c10 = Month.c(this.dateSelector.getSelectedDays().iterator().next().longValue());
                if (monthInValidRange(c10, this.calendarConstraints)) {
                    return c10;
                }
            }
            Month d10 = Month.d();
            if (monthInValidRange(d10, this.calendarConstraints)) {
                return d10;
            }
