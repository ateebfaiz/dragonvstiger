...
public final class CommonNotificationBuilder {
    ...
    public static class DisplayNotificationInfo {
        ...
        public final int f9196id;
        public final NotificationCompat.Builder notificationBuilder;
        public final String tag;

        DisplayNotificationInfo(NotificationCompat.Builder builder, String str, int i10) {
    ...
    private static boolean isValidIcon(Resources resources, int i10) {
        ...
        try {
            if (!b.a(resources.getDrawable(i10, (Resources.Theme) null))) {
                return true;
            }
