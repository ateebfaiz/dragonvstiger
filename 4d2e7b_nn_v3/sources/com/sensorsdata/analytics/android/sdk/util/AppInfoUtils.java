...
public class AppInfoUtils {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:11:0x001f A[Catch:{ all -> 0x0039 }] */
    ...
    private static java.lang.String getCurrentProcessNameByCmd() {
        /*
            ...
            byte[] r3 = new byte[r1]     // Catch:{ all -> 0x0039 }
            r4 = 0
            r5 = r4
        L_0x000e:
            int r6 = r2.read()     // Catch:{ all -> 0x0039 }
            if (r6 <= 0) goto L_0x001d
            if (r5 >= r1) goto L_0x001d
            int r7 = r5 + 1
            byte r6 = (byte) r6     // Catch:{ all -> 0x0039 }
            r3[r5] = r6     // Catch:{ all -> 0x0039 }
            r5 = r7
            goto L_0x000e
        L_0x001d:
            ...
            r1.<init>(r3, r4, r5, r6)     // Catch:{ all -> 0x0039 }
