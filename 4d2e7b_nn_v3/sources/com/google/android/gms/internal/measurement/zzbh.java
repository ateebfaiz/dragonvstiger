...
public final class zzbh extends zzaw {
    ...
    private static zzap zzc(j jVar, Iterator it, zzap zzap) {
        if (it != null) {
            while (it.hasNext()) {
                zzap zzc = jVar.a((zzap) it.next()).zzc((zzae) zzap);
    ...
    private static zzap zzd(j jVar, zzap zzap, zzap zzap2) {
        return zzc(jVar, zzap.zzl(), zzap2);
    }

    private static zzap zze(j jVar, zzap zzap, zzap zzap2) {
        if (zzap instanceof Iterable) {
            return zzc(jVar, ((Iterable) zzap).iterator(), zzap2);
        }
            ...
            switch (ordinal) {
                case 26:
                    ...
                    if (list.get(0) instanceof zzat) {
                        return zzd(new k(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_IN must be a string");
                case 27:
                    zzh.zzh(zzbl.FOR_IN_CONST.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return zzd(new h(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_IN_CONST must be a string");
                case MotionEventCompat.AXIS_RELATIVE_Y /*28*/:
                    zzh.zzh(zzbl.FOR_IN_LET.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return zzd(new i(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                ...
                case 30:
                    ...
                    if (list.get(0) instanceof zzat) {
                        return zze(new k(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_OF must be a string");
                case 31:
                    zzh.zzh(zzbl.FOR_OF_CONST.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return zze(new h(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
                    throw new IllegalArgumentException("Variable name in FOR_OF_CONST must be a string");
                case 32:
                    zzh.zzh(zzbl.FOR_OF_LET.name(), 3, list);
                    if (list.get(0) instanceof zzat) {
                        return zze(new i(zzg, ((zzap) list.get(0)).zzi()), zzg.zzb((zzap) list.get(1)), zzg.zzb((zzap) list.get(2)));
                    }
