...
abstract class HeaderBehavior<V extends View> extends ViewOffsetBehavior<V> {
    ...
    private class a implements Runnable {
        ...
        private final CoordinatorLayout f7905a;

        /* renamed from: b  reason: collision with root package name */
        private final View f7906b;

        a(CoordinatorLayout coordinatorLayout, View view) {
            this.f7905a = coordinatorLayout;
            this.f7906b = view;
        }

        public void run() {
            OverScroller overScroller;
            if (this.f7906b != null && (overScroller = HeaderBehavior.this.scroller) != null) {
                if (overScroller.computeScrollOffset()) {
                    HeaderBehavior headerBehavior = HeaderBehavior.this;
                    headerBehavior.setHeaderTopBottomOffset(this.f7905a, this.f7906b, headerBehavior.scroller.getCurrY());
                    ViewCompat.postOnAnimation(this.f7906b, this);
                    return;
                }
                HeaderBehavior.this.onFlingFinished(this.f7905a, this.f7906b);
            }
        }
    }
    ...
    /* access modifiers changed from: package-private */
    public int setHeaderTopBottomOffset(CoordinatorLayout coordinatorLayout, View view, int i10, int i11, int i12) {
        int clamp;
