...
public final class RouteSelector {
    ...
    private List<? extends InetSocketAddress> inetSocketAddresses = r.l();
    private int nextProxyIndex;
    private final List<Route> postponedRoutes = new ArrayList();
    private List<? extends Proxy> proxies = r.l();
    ...
    public RouteSelector(Address address2, RouteDatabase routeDatabase2, Call call2, EventListener eventListener2) {
        ...
        m.f(routeDatabase2, "routeDatabase");
    ...
    public final Selection next() throws IOException {
        if (hasNext()) {
            ...
            if (arrayList.isEmpty()) {
                r.z(arrayList, this.postponedRoutes);
