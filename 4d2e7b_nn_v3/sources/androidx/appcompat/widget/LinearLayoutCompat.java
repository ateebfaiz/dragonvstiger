...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public void drawDividersHorizontal(Canvas canvas) {
        ...
        for (int i13 = 0; i13 < virtualChildCount; i13++) {
            ...
            if (!(virtualChildAt == null || virtualChildAt.getVisibility() == 8 || !hasDividerBeforeChildAt(i13))) {
                LayoutParams layoutParams = (LayoutParams) virtualChildAt.getLayoutParams();
                if (isLayoutRtl) {
                    i12 = virtualChildAt.getRight() + layoutParams.rightMargin;
                } else {
                    i12 = (virtualChildAt.getLeft() - layoutParams.leftMargin) - this.mDividerWidth;
                }
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 != null) {
                ...
                if (isLayoutRtl) {
                    ...
                    i10 = virtualChildAt2.getRight() + layoutParams2.rightMargin;
    ...
    public void drawDividersVertical(Canvas canvas) {
        ...
        if (hasDividerBeforeChildAt(virtualChildCount)) {
            ...
            if (virtualChildAt2 == null) {
                ...
                i10 = virtualChildAt2.getBottom() + ((LayoutParams) virtualChildAt2.getLayoutParams()).bottomMargin;
            }
    ...
    public void layoutVertical(int i10, int i11, int i12, int i13) {
        ...
        int i21 = i20 & 112;
        int i22 = i20 & GravityCompat.RELATIVE_HORIZONTAL_GRAVITY_MASK;
        if (i21 == 16) {
            i14 = getPaddingTop() + (((i13 - i11) - this.mTotalLength) / 2);
        } else if (i21 != 80) {
            i14 = getPaddingTop();
        } else {
            i14 = ((getPaddingTop() + i13) - i11) - this.mTotalLength;
        }
        int i23 = 0;
        while (i23 < virtualChildCount) {
            View virtualChildAt = getVirtualChildAt(i23);
            if (virtualChildAt == null) {
                i14 += measureNullChild(i23);
                ...
                int absoluteGravity = GravityCompat.getAbsoluteGravity(i24, ViewCompat.getLayoutDirection(this)) & 7;
                if (absoluteGravity == 1) {
                    i16 = ((paddingRight2 - measuredWidth) / 2) + paddingLeft + layoutParams.leftMargin;
                ...
                if (hasDividerBeforeChildAt(i23)) {
                    i14 += this.mDividerHeight;
                }
                int i26 = i14 + layoutParams.topMargin;
                setChildFrame(virtualChildAt, i25, i26 + getLocationOffset(virtualChildAt), measuredWidth, measuredHeight);
                i23 += getChildrenSkipCount(virtualChildAt, i23);
                i14 = i26 + measuredHeight + layoutParams.bottomMargin + getNextLocationOffset(virtualChildAt);
                i15 = 1;
                i23 += i15;
            }
            i15 = 1;
