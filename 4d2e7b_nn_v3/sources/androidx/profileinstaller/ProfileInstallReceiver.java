...
public class ProfileInstallReceiver extends BroadcastReceiver {
    ...
    class a implements ProfileInstaller.DiagnosticsCallback {
        a() {
        }
    ...
    public void onReceive(@NonNull Context context, @Nullable Intent intent) {
        ...
        if (intent != null) {
            ...
            if (ACTION_INSTALL_PROFILE.equals(action)) {
                ProfileInstaller.writeProfile(context, new androidx.credentials.a(), new a(), true);
            } else if (ACTION_SKIP_FILE.equals(action)) {
                Bundle extras2 = intent.getExtras();
                if (extras2 != null) {
                    String string = extras2.getString(EXTRA_SKIP_FILE_OPERATION);
                    if (EXTRA_SKIP_FILE_OPERATION_WRITE.equals(string)) {
                        ProfileInstaller.writeSkipFile(context, new androidx.credentials.a(), new a());
                    } else if (EXTRA_SKIP_FILE_OPERATION_DELETE.equals(string)) {
                        ProfileInstaller.deleteSkipFile(context, new androidx.credentials.a(), new a());
                    }
                }
                ...
                if (EXTRA_BENCHMARK_OPERATION_DROP_SHADER_CACHE.equals(string2)) {
                    ...
                    aVar.onResultReceived(16, (Object) null);
                }
            }
        }
    }
