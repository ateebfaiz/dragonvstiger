...
public class AFf1pSDK extends AFf1nSDK {
    ...
    public AFf1pSDK(@NonNull Runnable runnable, @NonNull ExecutorService executorService) {
        super("store", Constants.REFERRER_API_GOOGLE, runnable);
        this.AFInAppEventParameterName = executorService;
    }

    static /* synthetic */ void values(AFf1pSDK aFf1pSDK, InstallReferrerClient installReferrerClient, Context context, int i10) {
        aFf1pSDK.AFKeystoreWrapper.put(Constant.PARAM_OAUTH_CODE, String.valueOf(i10));
            ...
            try {
                ...
                if (installReferrerClient.isReady()) {
                    ...
                    if (installReferrer2 != null) {
                        ...
                        aFf1pSDK.AFInAppEventType.put(Constants.REFERRER, installReferrer2);
                    }
                    ...
                    aFf1pSDK.AFKeystoreWrapper.put(NotificationCompat.CATEGORY_ERROR, "ReferrerClient: InstallReferrer is not ready");
                }
                ...
                aFf1pSDK.AFKeystoreWrapper.put(NotificationCompat.CATEGORY_ERROR, th.getMessage());
        ...
        if (AFInAppEventParameterName(context)) {
            ...
            addObserver(new Observer() {
                /*  JADX ERROR: Method generation error
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.appsflyer.internal.AFf1kSDK.2.update(java.util.Observable, java.lang.Object):void, class status: UNLOADED
                    ...
                    */
                /*  JADX ERROR: Method generation error: Method args not loaded: com.appsflyer.internal.AFf1kSDK.2.update(java.util.Observable, java.lang.Object):void, class status: UNLOADED
                    jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.appsflyer.internal.AFf1kSDK.2.update(java.util.Observable, java.lang.Object):void, class status: UNLOADED
                    	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                    	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                    	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
...
/*
Method generation error in method: com.appsflyer.internal.AFf1kSDK.2.update(java.util.Observable, java.lang.Object):void, dex: classes.dex
                jadx.core.utils.exceptions.JadxRuntimeException: Method args not loaded: com.appsflyer.internal.AFf1kSDK.2.update(java.util.Observable, java.lang.Object):void, class status: UNLOADED
                	at jadx.core.dex.nodes.MethodNode.getArgRegs(MethodNode.java:278)
                	at jadx.core.codegen.MethodGen.addDefinition(MethodGen.java:116)
                	at jadx.core.codegen.ClassGen.addMethodCode(ClassGen.java:313)
            ...
            try {
                ...
                build.startConnection(new InstallReferrerStateListener() {
                    ...
                    public /* synthetic */ void lambda$onInstallReferrerSetupFinished$0(InstallReferrerClient installReferrerClient, Context context, int i10) {
                        AFf1pSDK.values(AFf1pSDK.this, installReferrerClient, context, i10);
                    }
                    ...
                    public final void onInstallReferrerSetupFinished(int i10) {
                        AFf1pSDK.this.AFInAppEventParameterName.execute(new q(this, build, context, i10));
                    }
                });
            } catch (Throwable th) {
