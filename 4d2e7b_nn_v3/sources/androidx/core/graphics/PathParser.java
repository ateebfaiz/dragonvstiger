...
public final class PathParser {
    ...
    private static void extract(java.lang.String r8, int r9, androidx.core.graphics.PathParser.a r10) {
        /*
            r0 = 0
            r10.f14926b = r0
            r1 = r9
        ...
        L_0x003c:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.core.graphics.PathParser.extract(java.lang.String, int, androidx.core.graphics.PathParser$a):void");
    }
    ...
    public static void updateNodes(@NonNull PathDataNode[] pathDataNodeArr, @NonNull PathDataNode[] pathDataNodeArr2) {
        for (int i10 = 0; i10 < pathDataNodeArr2.length; i10++) {
            char unused = pathDataNodeArr[i10].mType = pathDataNodeArr2[i10].mType;
    ...
    public static class PathDataNode {
        ...
        private static void drawArc(Path path, float f10, float f11, float f12, float f13, float f14, float f15, float f16, boolean z10, boolean z11) {
            ...
            if (d32 < 0.0d) {
                Log.w(PathParser.LOGTAG, "Points are too far apart " + d31);
                float sqrt = (float) (Math.sqrt(d31) / 1.99999d);
                drawArc(path, f10, f11, f12, f13, f19 * sqrt, f15 * sqrt, f16, z10, z11);
                return;
            }
            ...
            double d35 = d11 * d24;
            double d36 = d10 * d20;
            arcToBezier(path, (d35 * cos) - (d36 * d30), (d35 * d30) + (d36 * cos), d24, d20, d14, d19, radians, atan2, atan22);
        }
