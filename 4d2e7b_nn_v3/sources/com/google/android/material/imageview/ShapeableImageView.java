...
public class ShapeableImageView extends AppCompatImageView implements Shapeable {
    ...
    class a extends ViewOutlineProvider {
        ...
        private final Rect f8310a = new Rect();
        ...
        public void getOutline(View view, Outline outline) {
            if (ShapeableImageView.this.shapeAppearanceModel != null) {
                ...
                ShapeableImageView.this.destination.round(this.f8310a);
                ShapeableImageView.this.shadowDrawable.setBounds(this.f8310a);
    ...
    private void updateShapeMask(int i10, int i11) {
        this.destination.set((float) getPaddingLeft(), (float) getPaddingTop(), (float) (i10 - getPaddingRight()), (float) (i11 - getPaddingBottom()));
        this.pathProvider.calculatePath(this.shapeAppearanceModel, 1.0f, this.destination, this.path);
        this.maskPath.rewind();
        this.maskPath.addPath(this.path);
        this.maskRect.set(0.0f, 0.0f, (float) i10, (float) i11);
