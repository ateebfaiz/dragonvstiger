...
public class ShortcutInfoCompat {
    ...
    public static class Builder {
                ...
                if (this.mCapabilityBindingParams != null) {
                    ...
                    for (String next : this.mCapabilityBindingParams.keySet()) {
                        ...
                        for (String str : map.keySet()) {
                            ...
                            String str2 = next + DomExceptionUtils.SEPARATOR + str;
                            if (list == null) {
                                strArr = new String[0];
                            } else {
        ...
        public Builder(@NonNull Context context, @NonNull ShortcutInfo shortcutInfo) {
            ...
            shortcutInfoCompat.mIntents = (Intent[]) Arrays.copyOf(a10, a10.length);
    ...
    static List<ShortcutInfoCompat> fromShortcuts(@NonNull Context context, @NonNull List<ShortcutInfo> list) {
        ...
        for (ShortcutInfo a10 : list) {
            arrayList.add(new Builder(context, e.a(a10)).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        i.a();
        ShortcutInfo.Builder a10 = h.a(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
        IconCompat iconCompat = this.mIcon;
        if (iconCompat != null) {
            ShortcutInfo.Builder unused = a10.setIcon(iconCompat.toIcon(this.mContext));
        }
        if (!TextUtils.isEmpty(this.mLongLabel)) {
            ShortcutInfo.Builder unused2 = a10.setLongLabel(this.mLongLabel);
        }
        if (!TextUtils.isEmpty(this.mDisabledMessage)) {
            ShortcutInfo.Builder unused3 = a10.setDisabledMessage(this.mDisabledMessage);
        }
        ComponentName componentName = this.mActivity;
        if (componentName != null) {
        ...
        ShortcutInfo.Builder unused6 = a10.setRank(this.mRank);
        PersistableBundle persistableBundle = this.mExtras;
        if (persistableBundle != null) {
        ...
        if (Build.VERSION.SDK_INT >= 29) {
            ...
            if (personArr != null && personArr.length > 0) {
                ...
                ShortcutInfo.Builder unused8 = a10.setPersons(personArr2);
            }
            LocusIdCompat locusIdCompat = this.mLocusId;
            if (locusIdCompat != null) {
                ShortcutInfo.Builder unused9 = a10.setLocusId(locusIdCompat.toLocusId());
            }
            ShortcutInfo.Builder unused10 = a10.setLongLived(this.mIsLongLived);
        } else {
            ShortcutInfo.Builder unused11 = a10.setExtras(buildLegacyExtrasBundle());
        }
        if (Build.VERSION.SDK_INT >= 33) {
            a.a(a10, this.mExcludedSurfaces);
        }
        return a10.build();
    }
