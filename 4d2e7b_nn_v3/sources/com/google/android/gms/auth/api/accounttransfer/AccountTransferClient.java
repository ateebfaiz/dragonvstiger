...
public class AccountTransferClient extends GoogleApi<zzr> {
    ...
    static {
        ...
        b bVar = new b();
        zzc = bVar;
        zzd = new Api("AccountTransfer.ACCOUNT_TRANSFER_API", bVar, clientKey);
    }

    AccountTransferClient(@NonNull Activity activity, @Nullable zzr zzr) {
    ...
    public Task<Void> notifyCompletion(@NonNull String str, int i10) {
        Preconditions.checkNotNull(str);
        return doWrite(new i(this, 1610, new zzav(str, i10)));
    }
    ...
    AccountTransferClient(@NonNull Context context, @Nullable zzr zzr) {
