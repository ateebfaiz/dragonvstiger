...
class h implements Cloneable {
    ...
    private static void B(long[] jArr, int i10, int i11, int i12, int[] iArr) {
        while (true) {
            i11--;
            if (i11 < i12) {
                return;
    ...
    private static int C(long[] jArr, int i10, int i11, int i12, int[] iArr) {
        int i13;
        long[] jArr2 = jArr;
        int i14 = i10;
        int i15 = i11;
        ...
        int max = Math.max(i16, i21 + 64);
        int min2 = (i19 + Math.min(min - max, i16 - i13)) >> 6;
        if (min2 > 1) {
            int i22 = i20 - min2;
            E(jArr, i10, i20, i22, i12, iArr);
            while (i20 > i22) {
                i20--;
                jArr2[i14 + i20] = 0;
            }
        ...
        if (min > max) {
            G(jArr, i10, i20, max, i12, iArr);
        } else {
            max = min;
        }
        if (max > i16) {
            B(jArr, i10, max, i16, iArr2);
        }
        return i17;
    }

    private static h D(long[] jArr, int i10, int i11, int i12, int[] iArr) {
        return new h(jArr, i10, C(jArr, i10, i11, i12, iArr));
    }

    private static void E(long[] jArr, int i10, int i11, int i12, int i13, int[] iArr) {
        int i14 = (i12 << 6) - i13;
        int length = iArr.length;
        while (true) {
            length--;
    ...
    private static void F(long[] jArr, int i10, int i11, long j10, int i12, int[] iArr) {
        int i13 = i11 - i12;
        int length = iArr.length;
        while (true) {
            length--;
    ...
    private static void G(long[] jArr, int i10, int i11, int i12, int i13, int[] iArr) {
        int i14 = i12 >>> 6;
        int i15 = i11;
        while (true) {
            int i16 = i15 - 1;
    ...
    private static void K(long[] jArr, int i10, int i11, int[] iArr) {
        int i12 = i10 << 1;
        while (true) {
            i10--;
            if (i10 >= 0) {
    ...
    private static boolean L(long[] jArr, int i10, int i11) {
        if ((jArr[i10 + (i11 >>> 6)] & (1 << (i11 & 63))) != 0) {
            return true;
        }
        return false;
    }
    ...
    private static void b(long[] jArr, int i10, long[] jArr2, int i11, long[] jArr3, int i12, int i13) {
    ...
    private void e(h hVar, int i10, int i11) {
        int i12 = (i10 + 63) >>> 6;
        int i13 = i11 >>> 6;
        int i14 = i11 & 63;
        if (i14 == 0) {
            a(this.f166a, i13, hVar.f166a, 0, i12);
            return;
        }
        long h10 = h(this.f166a, i13, hVar.f166a, 0, i12, i14);
        if (h10 != 0) {
            long[] jArr = this.f166a;
            int i15 = i12 + i13;
            jArr[i15] = h10 ^ jArr[i15];
        }
    }

    private static long g(long[] jArr, int i10, long[] jArr2, int i11, int i12, int i13) {
        int i14 = 64 - i13;
        long j10 = 0;
        while (true) {
            i12--;
    ...
    private static int i(long r3) {
        ...
        L_0x002e:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: dd.h.i(long):int");
    }
    ...
    private static void l(long[] jArr, int i10, int i11) {
        int i12 = i10 + (i11 >>> 6);
        jArr[i12] = jArr[i12] ^ (1 << (i11 & 63));
    }

    private static void m(long[] jArr, int i10, long[] jArr2, int i11, int i12, int i13) {
        int i14 = i10 + (i13 >>> 6);
        int i15 = i13 & 63;
        if (i15 == 0) {
    ...
    private static void n(long[] jArr, int i10, int i11, long j10) {
        int i12 = i10 + (i11 >>> 6);
        int i13 = i11 & 63;
        if (i13 == 0) {
    ...
    private static long q(int i10) {
        ...
        return (((long) s10) & 4294967295L) | ((((long) ((sArr[i10 >>> 24] << 16) | s11)) & 4294967295L) << 32);
    }

    private static void y(long j10, long[] jArr, int i10, long[] jArr2, int i11) {
        int i12 = i10;
        long[] jArr3 = jArr2;
        int i13 = i11;
        if ((j10 & 1) != 0) {
        ...
        while (true) {
            ...
            if (j12 != 0) {
                if ((j12 & 1) != 0) {
                    long h10 = h(jArr2, i11, jArr, 0, i10, i14);
                    if (h10 != 0) {
                        int i15 = i13 + i12;
                        jArr3[i15] = h10 ^ jArr3[i15];
                    }
                }
                i14++;
                j11 = j12;
    ...
    public boolean equals(Object obj) {
        ...
        for (int i10 = 0; i10 < o10; i10++) {
            if (this.f166a[i10] != hVar.f166a[i10]) {
                return false;
            }
        }
        return true;
    ...
    public void f(h hVar, int i10) {
        ...
        if (o10 != 0) {
            ...
            a(this.f166a, i10, hVar.f166a, 0, o10);
        }
    }
    ...
    public h t(int i10, int[] iArr) {
        ...
        if (j10 == 0) {
            ...
            int i12 = (i10 + 63) >>> 6;
            h hVar = new h(i12);
            A(hVar.f166a, 0, i10, i10, iArr);
            h hVar2 = new h(i12);
            hVar2.f166a[0] = 1;
            h hVar3 = new h(i12);
            int[] iArr2 = {j10, i10 + 1};
            h[] hVarArr = {(h) clone(), hVar};
            int[] iArr3 = {1, 0};
            h[] hVarArr2 = {hVar2, hVar3};
            int i13 = iArr2[1];
            int i14 = i13 - iArr2[0];
            int i15 = 1;
            while (true) {
                ...
                int i16 = 1 - i15;
                hVarArr[i15].e(hVarArr[i16], iArr2[i16], i14);
                int k10 = hVarArr[i15].k(i13);
                if (k10 == 0) {
                    return hVarArr2[i16];
                }
                int i17 = iArr3[i16];
                hVarArr2[i15].e(hVarArr2[i16], i17, i14);
                int i18 = i17 + i14;
                if (i18 > i11) {
                    i11 = i18;
                } else if (i18 == i11) {
                    i11 = hVarArr2[i15].k(i11);
                }
                i14 += k10 - i13;
                i13 = k10;
            }
    ...
    public String toString() {
        ...
        int i10 = o10 - 1;
        StringBuffer stringBuffer = new StringBuffer(Long.toBinaryString(this.f166a[i10]));
        while (true) {
            i10--;
            if (i10 < 0) {
                return stringBuffer.toString();
            }
            String binaryString = Long.toBinaryString(this.f166a[i10]);
    ...
    public h u(h hVar, int i10, int[] iArr) {
        int i11;
        int i12;
        h hVar2;
        h hVar3;
        ...
        if (i17 == 1) {
            long j12 = hVar2.f166a[0];
            if (j12 == 1) {
                return hVar3;
            }
            long[] jArr2 = new long[i19];
            y(j12, hVar3.f166a, i18, jArr2, 0);
            return D(jArr2, 0, i19, i16, iArr2);
        }
        int i20 = (i11 + 70) >>> 6;
        ...
        iArr3[1] = i20;
        System.arraycopy(hVar3.f166a, 0, jArr3, i20, i18);
        int i22 = 2;
        int i23 = i20;
        for (int i24 = 16; i22 < i24; i24 = 16) {
            ...
            if ((i22 & 1) == 0) {
                jArr = jArr3;
                i15 = i21;
                I(jArr3, i23 >>> 1, jArr3, i23, i20, 1);
            } else {
                jArr = jArr3;
                i15 = i21;
                b(jArr, i20, jArr3, i23 - i20, jArr, i23, i20);
            }
            i22++;
            i21 = i15;
            jArr3 = jArr;
        ...
        I(jArr4, 0, jArr5, 0, i25, 4);
        long[] jArr6 = hVar2.f166a;
        int i26 = i19 << 3;
        ...
        while (i27 < i17) {
            ...
            while (true) {
                i13 = i26;
                i14 = i27;
                c(jArr7, i28, jArr4, iArr3[((int) j13) & 15], jArr5, iArr3[((int) (j13 >>> 4)) & 15], i20);
                j13 >>>= 8;
                if (j13 == 0) {
                    break;
                }
        ...
        while (true) {
            i26 -= i19;
            if (i26 == 0) {
                return D(jArr7, 0, i19, i16, iArr2);
            }
            h(jArr7, i26 - i19, jArr7, i26, i19, 8);
        }
    }

    public h v(int i10, int[] iArr) {
        int o10 = o();
        if (o10 == 0) {
            return this;
        }
        ...
        return new h(jArr, 0, C(jArr, 0, i11, i10, iArr));
    }

    public h w(int i10, int i11, int[] iArr) {
        int o10 = o();
        if (o10 == 0) {
            return this;
        }
        ...
        System.arraycopy(this.f166a, 0, jArr, 0, o10);
        while (true) {
            i10--;
            if (i10 < 0) {
                return new h(jArr, 0, o10);
            }
            K(jArr, o10, i11, iArr);
    ...
    public h x(h hVar, int i10, int[] iArr) {
        int i11;
        int i12;
        h hVar2;
        h hVar3;
        ...
        if (i14 == 1) {
            ...
            y(j12, hVar3.f166a, i15, jArr2, 0);
            return new h(jArr2, 0, i16);
        }
        int i17 = (i11 + 70) >>> 6;
        ...
        iArr2[1] = i17;
        System.arraycopy(hVar3.f166a, 0, jArr3, i17, i15);
        int i19 = 2;
        int i20 = i17;
        ...
        for (int i24 = 0; i24 < i14; i24++) {
            ...
            long j13 = jArr6[i24];
            while (true) {
                c(jArr7, i25, jArr4, iArr2[((int) j13) & 15], jArr5, iArr2[((int) (j13 >>> 4)) & 15], i17);
                j13 >>>= 8;
                if (j13 == 0) {
                    break;
                }
    ...
    public void z(int i10, int[] iArr) {
        long[] jArr = this.f166a;
        int C = C(jArr, 0, jArr.length, i10, iArr);
        if (C < jArr.length) {
    ...
    public h(long[] jArr, int i10, int i11) {
