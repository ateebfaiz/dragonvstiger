...
public final class AdjustLinkResolution {
    ...
    public class a implements Runnable {
        ...
        public final /* synthetic */ URL f17419a;

        /* renamed from: b  reason: collision with root package name */
        public final /* synthetic */ AdjustLinkResolutionCallback f17420b;

        public a(URL url, AdjustLinkResolutionCallback adjustLinkResolutionCallback) {
            this.f17419a = url;
            this.f17420b = adjustLinkResolutionCallback;
        }

        public final void run() {
            AdjustLinkResolution.requestAndResolve(this.f17419a, 0, this.f17420b);
        }
    }
