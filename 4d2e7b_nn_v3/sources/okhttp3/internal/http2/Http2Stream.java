...
public final class Http2Stream {
                        ...
                        try {
                            ...
                            if (!this.closed) {
                                if (this.readBuffer.size() > j13) {
                                    ...
                                    j11 = buffer3.read(buffer2, Math.min(j12, buffer3.size()));
                                    Http2Stream http2Stream = Http2Stream.this;
    ...
    public Http2Stream(int i10, Http2Connection http2Connection, boolean z10, boolean z11, Headers headers) {
        ...
        this.source = new FramingSource((long) http2Connection.getOkHttpSettings().getInitialWindowSize(), z11);
    ...
    private final boolean closeInternal(ErrorCode errorCode2, IOException iOException) {
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            synchronized (this) {
                ...
                notifyAll();
                Unit unit = Unit.f12577a;
                this.connection.removeStream$okhttp(this.f1395id);
                return true;
            }
        }
        StringBuilder sb2 = new StringBuilder();
    ...
    public final void close(ErrorCode errorCode2, IOException iOException) throws IOException {
        m.f(errorCode2, "rstStatusCode");
        if (closeInternal(errorCode2, iOException)) {
            this.connection.writeSynReset$okhttp(this.f1395id, errorCode2);
        }
    }
    ...
    public final void closeLater(ErrorCode errorCode2) {
        ...
        if (closeInternal(errorCode2, (IOException) null)) {
            this.connection.writeSynResetLater$okhttp(this.f1395id, errorCode2);
        }
    }

    public final void enqueueTrailers(Headers headers) {
        m.f(headers, "trailers");
        synchronized (this) {
            boolean z10 = true;
            if (!this.sink.getFinished()) {
                if (headers.size() == 0) {
    ...
    public final okio.Sink getSink() {
        ...
        L_0x0011:
            ...
            kotlin.Unit r0 = kotlin.Unit.f12577a     // Catch:{ all -> 0x000e }
            monitor-exit(r2)
    ...
    public final void receiveData(BufferedSource bufferedSource, int i10) throws IOException {
        m.f(bufferedSource, "source");
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            this.source.receive$okhttp(bufferedSource, (long) i10);
            return;
        }
        StringBuilder sb2 = new StringBuilder();
        sb2.append("Thread ");
    ...
    public final void receiveHeaders(okhttp3.Headers r3, boolean r4) {
        ...
        L_0x005b:
            ...
            kotlin.Unit r4 = kotlin.Unit.f12577a     // Catch:{ all -> 0x004b }
            monitor-exit(r2)
    ...
    public final void writeHeaders(List<Header> list, boolean z10, boolean z11) throws IOException {
        ...
        if (!Util.assertionsEnabled || !Thread.holdsLock(this)) {
            ...
            this.connection.writeHeaders$okhttp(this.f1395id, z10, list);
            if (z11) {
    ...
    public final class FramingSink implements Sink {
        ...
        private final void emitFrame(boolean z10) throws IOException {
            ...
            synchronized (Http2Stream.this) {
                try {
                    ...
                    if (z10 && min == this.sendBuffer.size() && Http2Stream.this.getErrorCode$okhttp() == null) {
                        z11 = true;
                    } else {
                        z11 = false;
                    }
        ...
        public void close() throws java.io.IOException {
            ...
            L_0x004e:
                r1 = r2
            L_0x004f:
                kotlin.Unit r4 = kotlin.Unit.f12577a     // Catch:{ all -> 0x00d5 }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
            ...
            L_0x00bb:
                ...
                kotlin.Unit r1 = kotlin.Unit.f12577a     // Catch:{ all -> 0x00d2 }
                monitor-exit(r0)
                okhttp3.internal.http2.Http2Stream r0 = okhttp3.internal.http2.Http2Stream.this
                okhttp3.internal.http2.Http2Connection r0 = r0.getConnection()
                r0.flush()
