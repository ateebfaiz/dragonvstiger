...
public final class MaterialTextInputPicker<S> extends g {
    ...
    class a extends OnSelectionChangedListener {
        a() {
        }
    ...
    @NonNull
    static <T> MaterialTextInputPicker<T> newInstance(DateSelector<T> dateSelector2, @StyleRes int i10, @NonNull CalendarConstraints calendarConstraints2) {
