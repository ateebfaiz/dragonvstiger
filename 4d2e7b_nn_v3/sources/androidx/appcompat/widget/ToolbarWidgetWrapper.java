...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class a implements View.OnClickListener {
        ...
        final ActionMenuItem f14306a;

        a() {
            this.f14306a = new ActionMenuItem(ToolbarWidgetWrapper.this.mToolbar.getContext(), 0, 16908332, 0, 0, ToolbarWidgetWrapper.this.mTitle);
        }
        ...
        public void onClick(View view) {
            ...
            if (callback != null && toolbarWidgetWrapper.mMenuPrepared) {
                callback.onMenuItemSelected(0, this.f14306a);
            }
        }
    }
    ...
    class b extends ViewPropertyAnimatorListenerAdapter {
        ...
        public void onAnimationEnd(View view) {
            if (!this.f14308a) {
                ToolbarWidgetWrapper.this.mToolbar.setVisibility(this.f14309b);
            }
        }
    ...
    public void setNavigationMode(int i10) {
        ...
        if (i10 != i11) {
            ...
            } else if (i11 == 2 && (view = this.mTabView) != null && view.getParent() == (toolbar2 = this.mToolbar)) {
    ...
    public ViewPropertyAnimatorCompat setupAnimatorToVisibility(int i10, long j10) {
        ...
        return animate.alpha(f10).setDuration(j10).setListener(new b(i10));
    }
    ...
    public void setNavigationContentDescription(int i10) {
        setNavigationContentDescription((CharSequence) i10 == 0 ? null : getContext().getString(i10));
    }
