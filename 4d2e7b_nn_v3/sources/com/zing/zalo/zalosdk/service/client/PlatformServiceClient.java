...
public class PlatformServiceClient implements ServiceConnection {
    ...
    PlatformServiceClient(Context context2, int i10) {
    ...
    private void populateRequestBundle(Bundle bundle) {
    }

    private void sendMessage() {
        Bundle bundle = new Bundle();
        bundle.putString("com.zing.zalo.platform.request.APPLICATION_ID", AppInfo.getAppId(getContext()));
    ...
    public boolean start() {
        ...
        if (this.running || (createPlatformServiceIntent = NativeProtocol.createPlatformServiceIntent(this.context)) == null) {
            return false;
        }
        this.running = true;
