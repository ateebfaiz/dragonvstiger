...
public class CrossPromotionHelper {
    ...
    public static void setUrl(java.util.Map<java.lang.String, java.lang.String> r5) {
        ...
        L_0x004a:
            ...
            goto L_0x0008
        L_0x004d:
            com.appsflyer.internal.AFf1bSDK.valueOf = r1
            goto L_0x0008
        L_0x0050:
            return
        */
    ...
    private static void values(@NonNull String str, @NonNull Context context, @Nullable AFe1oSDK aFe1oSDK) {
        ...
        afDebugLog.AFInAppEventType.execute(new Runnable(aFd1lSDK) {
...
*/
    ...
    public static void logAndOpenStore(@NonNull Context context, String str, String str2, Map<String, String> map) {
        LinkGenerator AFInAppEventType = AFInAppEventType(context, str, str2, map, String.format(AFf1bSDK.valueOf, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1xSDK.AFInAppEventType().getHostName()}));
    ...
    public static void logCrossPromoteImpression(@NonNull Context context, String str, String str2, Map<String, String> map) {
        if (AppsFlyerProperties.getInstance().getBoolean(AppsFlyerProperties.AF_WAITFOR_CUSTOMERID, false)) {
            ...
            values(AFInAppEventType(context, str, str2, map, String.format(values, new Object[]{AppsFlyerLib.getInstance().getHostPrefix(), AFb1xSDK.AFInAppEventType().getHostName()})).generateLink(), context, (AFe1oSDK) null);
        }
    }
}
