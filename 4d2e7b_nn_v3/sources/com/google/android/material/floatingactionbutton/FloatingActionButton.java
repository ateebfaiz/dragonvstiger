...
public class FloatingActionButton extends VisibilityAwareImageButton implements TintableBackgroundView, TintableImageSourceView, ExpandableTransformationWidget, Shapeable, CoordinatorLayout.AttachedBehavior {
    ...
    class a implements d.k {
        ...
        final /* synthetic */ OnVisibilityChangedListener f8226a;

        a(OnVisibilityChangedListener onVisibilityChangedListener) {
            this.f8226a = onVisibilityChangedListener;
        }

        public void a() {
            this.f8226a.onShown(FloatingActionButton.this);
        }

        public void b() {
            this.f8226a.onHidden(FloatingActionButton.this);
        }
    }
    ...
    class c implements d.j {
        ...
        /* renamed from: a  reason: collision with root package name */
        private final TransformationCallback f8229a;

        c(TransformationCallback transformationCallback) {
            this.f8229a = transformationCallback;
        }

        public void a() {
            this.f8229a.onTranslationChanged(FloatingActionButton.this);
        }

        public void b() {
            this.f8229a.onScaleChanged(FloatingActionButton.this);
        }

        public boolean equals(Object obj) {
            if (!(obj instanceof c) || !((c) obj).f8229a.equals(this.f8229a)) {
                return false;
            }
            return true;
        }
    ...
    @Nullable
    private d.k wrapOnVisibilityChangedListener(@Nullable OnVisibilityChangedListener onVisibilityChangedListener) {
    ...
    public ShapeAppearanceModel getShapeAppearanceModel() {
        return (ShapeAppearanceModel) Preconditions.checkNotNull(getImpl().t());
    }
    ...
    public void removeTransformationCallback(@NonNull TransformationCallback<? extends FloatingActionButton> transformationCallback) {
        getImpl().L(new c(transformationCallback));
    }
    ...
    public void setShapeAppearanceModel(@NonNull ShapeAppearanceModel shapeAppearanceModel) {
        getImpl().Z(shapeAppearanceModel);
    }

    public void setShowMotionSpec(@Nullable MotionSpec motionSpec) {
        getImpl().a0(motionSpec);
    }
    ...
    public void hide(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z10) {
        getImpl().v(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z10);
    }

    /* access modifiers changed from: package-private */
    public void show(@Nullable OnVisibilityChangedListener onVisibilityChangedListener, boolean z10) {
        getImpl().e0(wrapOnVisibilityChangedListener(onVisibilityChangedListener), z10);
    }
}
