...
public final class FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1 extends SuspendLambda implements Function2<d, d, Object> {
    ...
    public FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1(c[] cVarArr, d dVar, o oVar) {
        super(2, dVar);
        this.$flows = cVarArr;
    ...
    public final Object invoke(d dVar, d dVar2) {
        return ((FlowKt__ZipKt$combineTransform$$inlined$combineTransformUnsafe$FlowKt__ZipKt$1) k(dVar, dVar2)).n(Unit.f12577a);
    }
}
