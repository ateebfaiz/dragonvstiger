...
public final class GsonBuilder {
    ...
    public Gson create() {
        ...
        boolean z10 = this.serializeNulls;
        boolean z11 = this.complexMapKeySerialization;
        boolean z12 = this.generateNonExecutableJson;
        boolean z13 = this.escapeHtmlChars;
        boolean z14 = this.prettyPrinting;
        boolean z15 = this.lenient;
        boolean z16 = this.serializeSpecialFloatingPointValues;
        boolean z17 = this.useJdkUnsafe;
        LongSerializationPolicy longSerializationPolicy2 = this.longSerializationPolicy;
        String str = this.datePattern;
        int i10 = this.dateStyle;
        int i11 = this.timeStyle;
        ...
        return new Gson(excluder3, fieldNamingStrategy, hashMap, z10, z11, z12, z13, z14, z15, z16, z17, longSerializationPolicy2, str, i10, i11, arrayList4, arrayList6, arrayList, toNumberStrategy, toNumberStrategy2, arrayList8);
    }
