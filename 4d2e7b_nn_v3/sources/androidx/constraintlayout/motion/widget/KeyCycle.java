...
public class KeyCycle extends Key {
    ...
    private static class a {
        ...
        private static SparseIntArray f14541a;

        static {
            SparseIntArray sparseIntArray = new SparseIntArray();
            f14541a = sparseIntArray;
            sparseIntArray.append(R.styleable.KeyCycle_motionTarget, 1);
            f14541a.append(R.styleable.KeyCycle_framePosition, 2);
            f14541a.append(R.styleable.KeyCycle_transitionEasing, 3);
            f14541a.append(R.styleable.KeyCycle_curveFit, 4);
            f14541a.append(R.styleable.KeyCycle_waveShape, 5);
            f14541a.append(R.styleable.KeyCycle_wavePeriod, 6);
            f14541a.append(R.styleable.KeyCycle_waveOffset, 7);
            f14541a.append(R.styleable.KeyCycle_waveVariesBy, 8);
            f14541a.append(R.styleable.KeyCycle_android_alpha, 9);
            f14541a.append(R.styleable.KeyCycle_android_elevation, 10);
            f14541a.append(R.styleable.KeyCycle_android_rotation, 11);
            f14541a.append(R.styleable.KeyCycle_android_rotationX, 12);
            f14541a.append(R.styleable.KeyCycle_android_rotationY, 13);
            f14541a.append(R.styleable.KeyCycle_transitionPathRotate, 14);
            f14541a.append(R.styleable.KeyCycle_android_scaleX, 15);
            f14541a.append(R.styleable.KeyCycle_android_scaleY, 16);
            f14541a.append(R.styleable.KeyCycle_android_translationX, 17);
            f14541a.append(R.styleable.KeyCycle_android_translationY, 18);
            f14541a.append(R.styleable.KeyCycle_android_translationZ, 19);
            f14541a.append(R.styleable.KeyCycle_motionProgress, 20);
        }
            ...
            for (int i10 = 0; i10 < indexCount; i10++) {
                ...
                switch (f14541a.get(index)) {
                    ...
                    case 20:
                        ...
                        break;
                    default:
                        Log.e("KeyCycle", "unused attribute 0x" + Integer.toHexString(index) + "   " + f14541a.get(index));
                        break;
                }
            }
        }
