...
public final class BeginSignInRequest extends AbstractSafeParcelable {
    ...
    public static final class GoogleIdTokenRequestOptions extends AbstractSafeParcelable {
        ...
        GoogleIdTokenRequestOptions(@SafeParcelable.Param(id = 1) boolean z10, @SafeParcelable.Param(id = 2) @Nullable String str, @SafeParcelable.Param(id = 3) @Nullable String str2, @SafeParcelable.Param(id = 4) boolean z11, @SafeParcelable.Param(id = 5) @Nullable String str3, @SafeParcelable.Param(id = 6) @Nullable List list, @SafeParcelable.Param(id = 7) boolean z12) {
            boolean z13 = true;
            if (z11 && z12) {
                z13 = false;
            }
    ...
    public static final class PasskeyJsonRequestOptions extends AbstractSafeParcelable {
        ...
        @SafeParcelable.Constructor
        PasskeyJsonRequestOptions(@SafeParcelable.Param(id = 1) boolean z10, @SafeParcelable.Param(id = 2) String str) {
            if (z10) {
