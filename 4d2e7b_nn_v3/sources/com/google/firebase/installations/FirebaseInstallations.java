...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    class a implements ThreadFactory {
        ...
        private final AtomicInteger f9118a = new AtomicInteger(1);

        a() {
        }

        public Thread newThread(Runnable runnable) {
            return new Thread(runnable, String.format("firebase-installations-executor-%d", new Object[]{Integer.valueOf(this.f9118a.getAndIncrement())}));
        }
    }
    ...
    class b implements FidListenerHandle {
        ...
        /* renamed from: a  reason: collision with root package name */
        final /* synthetic */ FidListener f9119a;

        b(FidListener fidListener) {
            this.f9119a = fidListener;
        }

        public void unregister() {
            synchronized (FirebaseInstallations.this) {
                FirebaseInstallations.this.fidListeners.remove(this.f9119a);
            }
        }
    }
    ...
    static /* synthetic */ class c {
        ...
        static {
            ...
            L_0x0012:
                r0 = 2
                int[] r2 = f9122b     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r2 = f9122b     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0039:
                int[] r1 = f9121a     // Catch:{ NoSuchFieldError -> 0x0043 }
    ...
    FirebaseInstallations(FirebaseApp firebaseApp2, @NonNull Provider<HeartBeatController> provider, @NonNull ExecutorService executorService, @NonNull Executor executor) {
        this(executorService, executor, firebaseApp2, new FirebaseInstallationServiceClient(firebaseApp2.getApplicationContext(), provider), new PersistedInstallation(firebaseApp2), Utils.getInstance(), new Lazy(new c(firebaseApp2)), new RandomFidGenerator());
    }

    private Task<InstallationTokenResult> addGetAuthTokenListener() {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        addStateListeners(new i(this.utils, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    private Task<String> addGetIdListener() {
        TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
        addStateListeners(new j(taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    private void addStateListeners(k kVar) {
    ...
    public final void lambda$getToken$2(boolean z10) {
        ...
        this.networkExecutor.execute(new d(this, z10));
    }
    ...
    private PersistedInstallationEntry fetchAuthTokenFromServer(@NonNull PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i10 = c.f9122b[generateAuthToken.getResponseCode().ordinal()];
        if (i10 == 1) {
    ...
    private PersistedInstallationEntry getMultiProcessSafePrefs() {
        ...
        synchronized (lockGenerateFid) {
            try {
                a10 = b.a(this.firebaseApp.getApplicationContext(), LOCKFILE_NAME_GENERATE_FID);
    ...
    private PersistedInstallationEntry registerFidWithServer(PersistedInstallationEntry persistedInstallationEntry) throws FirebaseInstallationsException {
        ...
        int i10 = c.f9121a[createFirebaseInstallation.getResponseCode().ordinal()];
        if (i10 == 1) {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new e(this));
    ...
    public Task<InstallationTokenResult> getToken(boolean z10) {
        ...
        this.backgroundExecutor.execute(new g(this, z10));
