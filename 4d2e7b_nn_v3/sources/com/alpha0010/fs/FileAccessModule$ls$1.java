...
@c(c = "com.alpha0010.fs.FileAccessModule$ls$1", f = "FileAccessModule.kt", l = {}, m = "invokeSuspend")
final class FileAccessModule$ls$1 extends SuspendLambda implements Function2<b0, d, Object> {
    ...
    FileAccessModule$ls$1(String str, FileAccessModule fileAccessModule, Promise promise, d dVar) {
        super(2, dVar);
        this.$path = str;
        ...
        if (this.label == 0) {
            ...
            try {
                ...
                for (DocumentFile name : listFiles) {
                    createArray.pushString(name.getName());
                }
    ...
    public final Object invoke(b0 b0Var, d dVar) {
        return ((FileAccessModule$ls$1) k(b0Var, dVar)).n(Unit.f12577a);
    }
}
