...
public final class MarkerEdgeTreatment extends EdgeTreatment {
    ...
    public void getEdgePath(float f10, float f11, float f12, @NonNull ShapePath shapePath) {
        ...
        shapePath.reset(f11 - sqrt, ((float) (-((((double) this.radius) * Math.sqrt(2.0d)) - ((double) this.radius)))) + sqrt2);
        shapePath.lineTo(f11, (float) (-((((double) this.radius) * Math.sqrt(2.0d)) - ((double) this.radius))));
        shapePath.lineTo(f11 + sqrt, ((float) (-((((double) this.radius) * Math.sqrt(2.0d)) - ((double) this.radius)))) + sqrt2);
    }
}
