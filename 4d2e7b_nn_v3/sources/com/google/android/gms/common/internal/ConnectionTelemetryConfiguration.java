...
public class ConnectionTelemetryConfiguration extends AbstractSafeParcelable {
    ...
    public ConnectionTelemetryConfiguration(@SafeParcelable.Param(id = 1) @NonNull RootTelemetryConfiguration rootTelemetryConfiguration, @SafeParcelable.Param(id = 2) boolean z10, @SafeParcelable.Param(id = 3) boolean z11, @SafeParcelable.Param(id = 4) @Nullable int[] iArr, @SafeParcelable.Param(id = 5) int i10, @SafeParcelable.Param(id = 6) @Nullable int[] iArr2) {
