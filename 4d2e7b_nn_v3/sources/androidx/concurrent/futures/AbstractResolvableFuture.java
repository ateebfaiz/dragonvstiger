...
public abstract class AbstractResolvableFuture<V> implements ListenableFuture<V> {
    ...
    private static final class c {
        ...
        static final c f14488c;

        /* renamed from: d  reason: collision with root package name */
        static final c f14489d;

        /* renamed from: a  reason: collision with root package name */
        final boolean f14490a;

        /* renamed from: b  reason: collision with root package name */
        final Throwable f14491b;
        ...
        static {
            ...
            f14489d = new c(false, (Throwable) null);
            f14488c = new c(true, (Throwable) null);
        }
    ...
    private static final class d {
        ...
        /* renamed from: b  reason: collision with root package name */
        static final d f14492b = new d(new a("Failure occurred while trying to finish a future."));

        /* renamed from: a  reason: collision with root package name */
        final Throwable f14493a;
        ...
        d(Throwable th) {
            this.f14493a = (Throwable) AbstractResolvableFuture.checkNotNull(th);
        }
    }
    ...
    private static final class e {
        ...
        /* renamed from: d  reason: collision with root package name */
        static final e f14494d = new e((Runnable) null, (Executor) null);

        /* renamed from: a  reason: collision with root package name */
        final Runnable f14495a;
    ...
    private static final class f extends b {
        ...
        /* renamed from: a  reason: collision with root package name */
        final AtomicReferenceFieldUpdater f14498a;

        /* renamed from: b  reason: collision with root package name */
        final AtomicReferenceFieldUpdater f14499b;

        /* renamed from: c  reason: collision with root package name */
        final AtomicReferenceFieldUpdater f14500c;

        /* renamed from: d  reason: collision with root package name */
        final AtomicReferenceFieldUpdater f14501d;

        /* renamed from: e  reason: collision with root package name */
        final AtomicReferenceFieldUpdater f14502e;

        f(AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater2, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater3, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater4, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater5) {
            super();
            this.f14498a = atomicReferenceFieldUpdater;
            this.f14499b = atomicReferenceFieldUpdater2;
            this.f14500c = atomicReferenceFieldUpdater3;
            this.f14501d = atomicReferenceFieldUpdater4;
            this.f14502e = atomicReferenceFieldUpdater5;
        }

        /* access modifiers changed from: package-private */
        public boolean a(AbstractResolvableFuture abstractResolvableFuture, e eVar, e eVar2) {
            return a.a(this.f14501d, abstractResolvableFuture, eVar, eVar2);
        }

        /* access modifiers changed from: package-private */
        public boolean b(AbstractResolvableFuture abstractResolvableFuture, Object obj, Object obj2) {
            return a.a(this.f14502e, abstractResolvableFuture, obj, obj2);
        }

        /* access modifiers changed from: package-private */
        public boolean c(AbstractResolvableFuture abstractResolvableFuture, i iVar, i iVar2) {
            return a.a(this.f14500c, abstractResolvableFuture, iVar, iVar2);
        }

        /* access modifiers changed from: package-private */
        public void d(i iVar, i iVar2) {
            this.f14499b.lazySet(iVar, iVar2);
        }

        /* access modifiers changed from: package-private */
        public void e(i iVar, Thread thread) {
            this.f14498a.lazySet(iVar, thread);
        }
    }
    ...
    private static final class g implements Runnable {
        ...
        /* renamed from: a  reason: collision with root package name */
        final AbstractResolvableFuture f14503a;

        /* renamed from: b  reason: collision with root package name */
        final ListenableFuture f14504b;

        g(AbstractResolvableFuture abstractResolvableFuture, ListenableFuture listenableFuture) {
            this.f14503a = abstractResolvableFuture;
            this.f14504b = listenableFuture;
        }

        public void run() {
            if (this.f14503a.value == this) {
                if (AbstractResolvableFuture.ATOMIC_HELPER.b(this.f14503a, this, AbstractResolvableFuture.getFutureValue(this.f14504b))) {
                    AbstractResolvableFuture.complete(this.f14503a);
                }
            }
        }
    }
    ...
    private static final class h extends b {
        ...
        public boolean a(AbstractResolvableFuture abstractResolvableFuture, e eVar, e eVar2) {
            synchronized (abstractResolvableFuture) {
                try {
                    if (abstractResolvableFuture.listeners != eVar) {
                        return false;
                    }
                    abstractResolvableFuture.listeners = eVar2;
                    return true;
                } catch (Throwable th) {
                    throw th;
                }
        ...
        public boolean c(AbstractResolvableFuture abstractResolvableFuture, i iVar, i iVar2) {
            synchronized (abstractResolvableFuture) {
                try {
                    if (abstractResolvableFuture.waiters != iVar) {
                        return false;
                    }
                    abstractResolvableFuture.waiters = iVar2;
                    return true;
                } catch (Throwable th) {
                    throw th;
                }
    ...
    private static final class i {
        ...
        /* renamed from: c  reason: collision with root package name */
        static final i f14505c = new i(false);

        /* renamed from: a  reason: collision with root package name */
        volatile Thread f14506a;
        ...
        public void a(i iVar) {
            AbstractResolvableFuture.ATOMIC_HELPER.d(this, iVar);
        }

        /* access modifiers changed from: package-private */
        public void b() {
            Thread thread = this.f14506a;
            if (thread != null) {
                this.f14506a = null;
    ...
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v3, resolved type: androidx.concurrent.futures.AbstractResolvableFuture$f} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v5, resolved type: androidx.concurrent.futures.AbstractResolvableFuture$h} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r2v6, resolved type: androidx.concurrent.futures.AbstractResolvableFuture$f} */
    /* JADX DEBUG: Multi-variable search result rejected for TypeSearchVarInfo{r3v7, resolved type: androidx.concurrent.futures.AbstractResolvableFuture$f} */
    /* JADX WARNING: Multi-variable type inference failed */
    static {
        /*
            java.lang.Class<androidx.concurrent.futures.AbstractResolvableFuture$i> r0 = androidx.concurrent.futures.AbstractResolvableFuture.i.class
            ...
            log = r2
            androidx.concurrent.futures.AbstractResolvableFuture$f r2 = new androidx.concurrent.futures.AbstractResolvableFuture$f     // Catch:{ all -> 0x0048 }
            ...
            java.lang.Class<androidx.concurrent.futures.AbstractResolvableFuture$e> r0 = androidx.concurrent.futures.AbstractResolvableFuture.e.class
        ...
        L_0x0048:
            r0 = move-exception
            androidx.concurrent.futures.AbstractResolvableFuture$h r2 = new androidx.concurrent.futures.AbstractResolvableFuture$h
            r2.<init>()
        L_0x004e:
            ATOMIC_HELPER = r2
    ...
    private e clearListeners(e eVar) {
        ...
        } while (!ATOMIC_HELPER.a(this, eVar2, e.f14494d));
        e eVar3 = eVar2;
        e eVar4 = eVar;
        e eVar5 = eVar3;
        while (eVar5 != null) {
            e eVar6 = eVar5.f14497c;
            eVar5.f14497c = eVar4;
            eVar4 = eVar5;
            eVar5 = eVar6;
        }
    ...
    static void complete(AbstractResolvableFuture<?> abstractResolvableFuture) {
        ...
        while (true) {
            ...
            e clearListeners = abstractResolvableFuture.clearListeners(eVar);
            while (true) {
                if (clearListeners != null) {
                    eVar = clearListeners.f14497c;
                    Runnable runnable = clearListeners.f14495a;
                    if (runnable instanceof g) {
                        g gVar = (g) runnable;
                        abstractResolvableFuture = gVar.f14503a;
                        if (abstractResolvableFuture.value == gVar) {
                            if (ATOMIC_HELPER.b(abstractResolvableFuture, gVar, getFutureValue(gVar.f14504b))) {
                            }
                        } else {
                            continue;
                        }
                    } else {
                        executeListener(runnable, clearListeners.f14496b);
                    }
                    clearListeners = eVar;
                } else {
                    return;
    ...
    private V getDoneValue(Object obj) throws ExecutionException {
        if (obj instanceof c) {
            throw cancellationExceptionWithCause("Task was cancelled.", ((c) obj).f14491b);
        } else if (obj instanceof d) {
            throw new ExecutionException(((d) obj).f14493a);
        } else if (obj == NULL) {
            return null;
        } else {
            return obj;
    ...
    static Object getFutureValue(ListenableFuture<?> listenableFuture) {
        if (listenableFuture instanceof AbstractResolvableFuture) {
            ...
            if (cVar.f14491b != null) {
                return new c(false, cVar.f14491b);
            }
            return c.f14489d;
        }
    ...
    private void releaseWaiters() {
        ...
        do {
            iVar = this.waiters;
        } while (!ATOMIC_HELPER.c(this, iVar, i.f14505c));
        while (iVar != null) {
            iVar.b();
            iVar = iVar.f14507b;
        }
    ...
    private void removeWaiter(i iVar) {
        ...
        while (true) {
            ...
            if (iVar2 != i.f14505c) {
                i iVar3 = null;
                while (iVar2 != null) {
                    i iVar4 = iVar2.f14507b;
                    if (iVar2.f14506a != null) {
                        iVar3 = iVar2;
                    } else if (iVar3 != null) {
                        iVar3.f14507b = iVar4;
                        if (iVar3.f14506a == null) {
                        }
    ...
    public final boolean cancel(boolean r8) {
        ...
        L_0x0008:
            r3 = r2
        L_0x0009:
            boolean r4 = r0 instanceof androidx.concurrent.futures.AbstractResolvableFuture.g
            r3 = r3 | r4
        ...
        L_0x001f:
            ...
            androidx.concurrent.futures.AbstractResolvableFuture$c r3 = androidx.concurrent.futures.AbstractResolvableFuture.c.f14488c
            goto L_0x0026
        L_0x0024:
            androidx.concurrent.futures.AbstractResolvableFuture$c r3 = androidx.concurrent.futures.AbstractResolvableFuture.c.f14489d
        L_0x0026:
            r4 = r7
            r5 = r2
        L_0x0028:
        ...
        L_0x0035:
            ...
            androidx.concurrent.futures.AbstractResolvableFuture$g r0 = (androidx.concurrent.futures.AbstractResolvableFuture.g) r0
            com.google.common.util.concurrent.ListenableFuture r0 = r0.f14504b
        ...
        L_0x004d:
            r5 = r2
        L_0x004e:
            boolean r6 = r0 instanceof androidx.concurrent.futures.AbstractResolvableFuture.g
            r5 = r5 | r6
    ...
    public String pendingToString() {
        Object obj = this.value;
        if (obj instanceof g) {
            return "setFuture=[" + userObjectToString(((g) obj).f14504b) + "]";
    ...
    public boolean setFuture(ListenableFuture<? extends V> listenableFuture) {
        ...
        if (obj instanceof c) {
            listenableFuture.cancel(((c) obj).f14490a);
        }
        return false;
    ...
    public final boolean wasInterrupted() {
        Object obj = this.value;
        if (!(obj instanceof c) || !((c) obj).f14490a) {
            return false;
        }
        return true;
    }
