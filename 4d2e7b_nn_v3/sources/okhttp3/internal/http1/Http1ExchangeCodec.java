...
public final class Http1ExchangeCodec implements ExchangeCodec {
        ...
        private final void readChunkSize() {
            ...
            try {
                ...
                if (readUtf8LineStrict != null) {
                    String obj = j.P0(readUtf8LineStrict).toString();
                    if (this.bytesRemainingInChunk < 0 || (obj.length() > 0 && !j.F(obj, ";", false, 2, (Object) null))) {
    ...
    private final boolean isChunked(Response response) {
        return j.q("chunked", Response.header$default(response, "Transfer-Encoding", (String) null, 2, (Object) null), true);
    }
    ...
    private final boolean isChunked(Request request) {
        return j.q("chunked", request.header("Transfer-Encoding"), true);
    }
}
