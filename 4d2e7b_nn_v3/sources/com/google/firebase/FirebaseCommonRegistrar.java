...
public class FirebaseCommonRegistrar implements ComponentRegistrar {
    ...
    public List<Component<?>> getComponents() {
        ...
        arrayList.add(LibraryVersionComponent.fromContext(TARGET_SDK, new e()));
        arrayList.add(LibraryVersionComponent.fromContext(MIN_SDK, new f()));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_PLATFORM, new g()));
        arrayList.add(LibraryVersionComponent.fromContext(ANDROID_INSTALLER, new h()));
