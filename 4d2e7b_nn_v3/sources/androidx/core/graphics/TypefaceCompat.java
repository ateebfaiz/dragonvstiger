...
public class TypefaceCompat {
    ...
    private static final a0 sTypefaceCompatImpl;
    ...
    static {
        ...
        if (i10 >= 29) {
            ...
            sTypefaceCompatImpl = new y();
        } else {
            sTypefaceCompatImpl = new z();
        }
    }
    ...
    public static Typeface createFromResourcesFamilyXml(@NonNull Context context, @NonNull FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry, @NonNull Resources resources, int i10, @Nullable String str, int i11, int i12, @Nullable ResourcesCompat.FontCallback fontCallback, @Nullable Handler handler, boolean z10) {
        ...
        if (familyResourceEntry2 instanceof FontResourcesParserCompat.ProviderResourceEntry) {
            ...
            typeface = FontsContractCompat.requestFont(context, providerResourceEntry.getRequest(), i12, !z10 ? fontCallback2 == null : providerResourceEntry.getFetchStrategy() == 0, z10 ? providerResourceEntry.getTimeout() : -1, ResourcesCompat.FontCallback.getHandler(handler), new ResourcesCallbackAdapter(fontCallback2));
            Resources resources2 = resources;
            int i13 = i12;
        } else {
            Context context2 = context;
            Resources resources3 = resources;
            typeface = sTypefaceCompatImpl.createFromFontFamilyFilesResourceEntry(context, (FontResourcesParserCompat.FontFamilyFilesResourceEntry) familyResourceEntry2, resources, i12);
            if (fontCallback2 != null) {
                if (typeface != null) {
        ...
        if (typeface != null) {
            sTypefaceCache.put(createResourceUid(resources, i10, str, i11, i12), typeface);
        }
        return typeface;
    }
    ...
    private static Typeface getBestFontFromFamily(Context context, Typeface typeface, int i10) {
        a0 a0Var = sTypefaceCompatImpl;
        FontResourcesParserCompat.FontFamilyFilesResourceEntry fontFamily = a0Var.getFontFamily(typeface);
        if (fontFamily == null) {
            return null;
        }
        return a0Var.createFromFontFamilyFilesResourceEntry(context, fontFamily, context.getResources(), i10);
    }
    ...
    public static Typeface findFromCache(@NonNull Resources resources, int i10, int i11) {
        return findFromCache(resources, i10, (String) null, 0, i11);
    }
    ...
    public static Typeface createFromResourcesFamilyXml(@NonNull Context context, @NonNull FontResourcesParserCompat.FamilyResourceEntry familyResourceEntry, @NonNull Resources resources, int i10, int i11, @Nullable ResourcesCompat.FontCallback fontCallback, @Nullable Handler handler, boolean z10) {
        return createFromResourcesFamilyXml(context, familyResourceEntry, resources, i10, (String) null, 0, i11, fontCallback, handler, z10);
    }
}
