...
final class HiddenActivity$handleGetSignInIntent$1$1 extends n implements Function1<PendingIntent, Unit> {
    final /* synthetic */ int $requestCode;
    final /* synthetic */ HiddenActivity this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    HiddenActivity$handleGetSignInIntent$1$1(HiddenActivity hiddenActivity, int i10) {
        super(1);
    ...
    public final void invoke(PendingIntent pendingIntent) {
        try {
            ...
            hiddenActivity.setupFailure(access$getResultReceiver$p, CredentialProviderBaseController.GET_UNKNOWN, "During get sign-in intent, one tap ui intent sender failure: " + e10.getMessage());
        }
    }
}
