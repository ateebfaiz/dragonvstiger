...
public abstract class VirtualView extends ReactViewGroup {
    ...
    ArrayList<m> elements;
    private double fontSize = -1.0d;
    private k glyphContext;
    RectF mBox;
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            L_0x0012:
                int[] r0 = f9744a     // Catch:{ NoSuchFieldError -> 0x001d }
            ...
            L_0x001d:
                int[] r0 = f9744a     // Catch:{ NoSuchFieldError -> 0x0028 }
            ...
            L_0x0028:
                int[] r0 = f9744a     // Catch:{ NoSuchFieldError -> 0x0033 }
            ...
            L_0x0033:
                int[] r0 = f9744a     // Catch:{ NoSuchFieldError -> 0x003e }
            ...
            L_0x003e:
                int[] r0 = f9744a     // Catch:{ NoSuchFieldError -> 0x0049 }
            ...
            L_0x0049:
                int[] r0 = f9744a     // Catch:{ NoSuchFieldError -> 0x0054 }
    ...
    private double fromRelativeFast(SVGLength sVGLength) {
        double d10;
        switch (a.f9744a[sVGLength.f9684b.ordinal()]) {
            case 1:
        ...
        return sVGLength.f9683a * d10 * ((double) this.mScale);
    }
    ...
    private float getCanvasHeight() {
        ...
        if (textRoot == null) {
            ...
            this.canvasHeight = textRoot.r().d();
        }
    ...
    public SvgView getSvgView() {
        ...
        if (parent instanceof SvgView) {
            ...
            z2.a.j("ReactNative", "RNSVG: " + getClass().getName() + " should be descendant of a SvgView.");
        }
        return this.svgView;
    }
    ...
    public double relativeOn(SVGLength sVGLength, float f10) {
        SVGLength.UnitType unitType = sVGLength.f9684b;
        if (unitType == SVGLength.UnitType.NUMBER) {
            return sVGLength.f9683a * ((double) this.mScale);
        }
        if (unitType == SVGLength.UnitType.PERCENTAGE) {
            return (sVGLength.f9683a / 100.0d) * ((double) f10);
        }
    ...
    public double relativeOnFraction(SVGLength sVGLength, float f10) {
        ...
        SVGLength.UnitType unitType = sVGLength.f9684b;
        if (unitType == SVGLength.UnitType.NUMBER) {
            d10 = sVGLength.f9683a;
        } else if (unitType != SVGLength.UnitType.PERCENTAGE) {
            return fromRelativeFast(sVGLength);
        } else {
            d10 = sVGLength.f9683a / 100.0d;
        }
    ...
    public void setClientRect(RectF rectF) {
        ...
        if (rectF2 == null || !rectF2.equals(rectF)) {
            ...
            if (rectF != null) {
                ...
                e c10 = k1.c(this.mContext, getId());
                if (c10 != null) {
                    c10.c(f0.b(getId(), floor, floor2, ceil, ceil2));
                }
            }
        }
    }
        ...
        if (this.mClipPath != null) {
            ...
            if (clipPathView != null) {
                if (this.mClipRule == 0) {
                    ...
                    path = clipPathView.s(canvas, paint, Region.Op.UNION);
                }
                ...
                if (i10 == 0) {
                    ...
                    z2.a.G("ReactNative", "RNSVG: clipRule: " + this.mClipRule + " unrecognized");
                }
                this.mCachedClipPath = path;
            } else {
                z2.a.G("ReactNative", "RNSVG: Undefined clipPath: " + this.mClipPath);
            }
        }
        return getClipPath();
    }
