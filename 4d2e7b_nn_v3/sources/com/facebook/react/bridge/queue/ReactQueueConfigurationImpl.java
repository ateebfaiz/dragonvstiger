...
public class ReactQueueConfigurationImpl implements ReactQueueConfiguration {
    ...
    public static ReactQueueConfigurationImpl create(ReactQueueConfigurationSpec reactQueueConfigurationSpec, QueueThreadExceptionHandler queueThreadExceptionHandler) {
        ...
        b10.put(mainThreadSpec, create);
        MessageQueueThreadImpl messageQueueThreadImpl = (MessageQueueThreadImpl) b10.get(reactQueueConfigurationSpec.getJSQueueThreadSpec());
        ...
        MessageQueueThreadImpl messageQueueThreadImpl2 = (MessageQueueThreadImpl) b10.get(reactQueueConfigurationSpec.getNativeModulesQueueThreadSpec());
