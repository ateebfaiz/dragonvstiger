...
class ThumbnailStreamOpener {
    ...
    private java.lang.String getPath(@androidx.annotation.NonNull android.net.Uri r7) {
        /*
            ...
            r1 = 0
            com.bumptech.glide.load.data.mediastore.ThumbnailQuery r2 = r6.query     // Catch:{ SecurityException -> 0x0027, all -> 0x0025 }
            android.database.Cursor r2 = r2.query(r7)     // Catch:{ SecurityException -> 0x0027, all -> 0x0025 }
