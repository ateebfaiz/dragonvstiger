...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private class f implements MenuPresenter {
        ...
        public void initForMenu(Context context, MenuBuilder menuBuilder) {
            ...
            MenuBuilder menuBuilder2 = this.f14303a;
            if (!(menuBuilder2 == null || (menuItemImpl = this.f14304b) == null)) {
                menuBuilder2.collapseItemActionView(menuItemImpl);
            }
            this.f14303a = menuBuilder;
        }
        ...
        public void updateMenuView(boolean z10) {
            if (this.f14304b != null) {
                MenuBuilder menuBuilder = this.f14303a;
                if (menuBuilder != null) {
                    int size = menuBuilder.size();
                    int i10 = 0;
                    while (i10 < size) {
                        if (this.f14303a.getItem(i10) != this.f14304b) {
                            i10++;
                        } else {
                            return;
                        }
                ...
                collapseItemActionView(this.f14303a, this.f14304b);
            }
        }
    }
    ...
    public boolean hasExpandedActionView() {
        f fVar = this.mExpandedMenuPresenter;
        if (fVar == null || fVar.f14304b == null) {
            return false;
        }
        return true;
    }
    ...
    public void onMeasure(int i10, int i11) {
        ...
        int i19 = 0;
        char c10 = isLayoutRtl ^ 1;
        if (shouldLayout(this.mNavButtonView)) {
            measureChildConstrained(this.mNavButtonView, i10, 0, i11, 0, this.mMaxButtonHeight);
            i14 = this.mNavButtonView.getMeasuredWidth() + getHorizontalMargins(this.mNavButtonView);
        ...
        if (shouldLayout(this.mCollapseButtonView)) {
            ...
            i14 = this.mCollapseButtonView.getMeasuredWidth() + getHorizontalMargins(this.mCollapseButtonView);
        ...
        iArr[isLayoutRtl] = Math.max(0, currentContentInsetStart - i14);
        ...
        if (shouldLayout(this.mSubtitleTextView)) {
            i17 = Math.max(i17, measureChildCollapseMargins(this.mSubtitleTextView, i10, max2 + i22, i11, i16 + i21, iArr));
    ...
    public Parcelable onSaveInstanceState() {
        ...
        f fVar = this.mExpandedMenuPresenter;
        if (!(fVar == null || (menuItemImpl = fVar.f14304b) == null)) {
    ...
    public void updateBackInvokedCallbackState() {
        ...
        if (Build.VERSION.SDK_INT >= 33) {
            ...
            if (!hasExpandedActionView() || a10 == null || !ViewCompat.isAttachedToWindow(this) || !this.mBackInvokedCallbackEnabled) {
                z10 = false;
            } else {
                z10 = true;
            }
            if (z10 && this.mBackInvokedDispatcher == null) {
                if (this.mBackInvokedCallback == null) {
                    this.mBackInvokedCallback = e.b(new t(this));
                }
    ...
    public Toolbar(@NonNull Context context, @Nullable AttributeSet attributeSet, int i10) {
        ...
        this.mMenuHostHelper = new MenuHostHelper(new u(this));
