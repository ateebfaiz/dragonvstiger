...
public class AuthenticatorAssertionResponse extends AuthenticatorResponse {
    ...
    AuthenticatorAssertionResponse(@SafeParcelable.Param(id = 2) @NonNull byte[] bArr, @SafeParcelable.Param(id = 3) @NonNull byte[] bArr2, @SafeParcelable.Param(id = 4) @NonNull byte[] bArr3, @SafeParcelable.Param(id = 5) @NonNull byte[] bArr4, @SafeParcelable.Param(id = 6) @Nullable byte[] bArr5) {
