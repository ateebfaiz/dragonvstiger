...
public class BrowserActionsIntent {
    ...
    private static a sDialogListenter;
    @NonNull
    ...
    public static List<BrowserActionItem> parseBrowserActionItems(ArrayList<Bundle> arrayList) {
        ...
        for (int i10 = 0; i10 < arrayList.size(); i10++) {
            ...
            arrayList2.add(new BrowserActionItem(string, pendingIntent, i11));
        }
        return arrayList2;
    }
    ...
    @VisibleForTesting
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    static void setDialogShownListenter(a aVar) {
    }
    ...
    public static void openBrowserAction(Context context, Uri uri, int i10, ArrayList<BrowserActionItem> arrayList, PendingIntent pendingIntent) {
    ...
    private static void openFallbackBrowserActionsMenu(Context context, Uri uri, int i10, List<BrowserActionItem> list) {
        new c(context, uri, list).a();
    }
