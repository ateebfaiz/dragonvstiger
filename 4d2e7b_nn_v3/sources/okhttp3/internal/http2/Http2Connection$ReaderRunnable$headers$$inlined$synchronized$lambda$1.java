...
public final class Http2Connection$ReaderRunnable$headers$$inlined$synchronized$lambda$1 extends Task {
    ...
    public Http2Connection$ReaderRunnable$headers$$inlined$synchronized$lambda$1(String str, boolean z10, String str2, boolean z11, Http2Stream http2Stream, Http2Connection.ReaderRunnable readerRunnable, Http2Stream http2Stream2, int i10, List list, boolean z12) {
        super(str2, z11);
        this.$name = str;
        this.$cancelable = z10;
    ...
    public long runOnce() {
        try {
            ...
            platform.log("Http2Connection.Listener failure for " + this.this$0.this$0.getConnectionName$okhttp(), 4, e10);
            try {
