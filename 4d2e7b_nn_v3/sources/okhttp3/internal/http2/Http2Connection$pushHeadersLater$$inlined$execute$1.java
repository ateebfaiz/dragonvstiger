...
public final class Http2Connection$pushHeadersLater$$inlined$execute$1 extends Task {
    ...
    public Http2Connection$pushHeadersLater$$inlined$execute$1(String str, boolean z10, String str2, boolean z11, Http2Connection http2Connection, int i10, List list, boolean z12) {
        super(str2, z11);
        this.$name = str;
        this.$cancelable = z10;
