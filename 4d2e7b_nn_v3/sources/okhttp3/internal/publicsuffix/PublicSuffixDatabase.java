...
public final class PublicSuffixDatabase {
    ...
    private static final List<String> PREVAILING_RULE = r.e(ProxyConfig.MATCH_ALL_SCHEMES);
            ...
            while (i13 < length) {
                ...
                while (true) {
                    if (z11) {
                        ...
                        boolean z12 = z11;
                        i12 = Util.and(bArr4[i18][i19], 255);
                        z10 = z12;
                    }
                    and = i12 - Util.and(bArr3[i15 + i20], 255);
                    if (and == 0) {
                        i20++;
                        i19++;
                        if (i20 == i17) {
    ...
    private final java.util.List<java.lang.String> findMatchingRule(java.util.List<java.lang.String> r18) {
        ...
        L_0x00b6:
            ...
            r10 = 0
            r11 = 0
            java.util.List r1 = kotlin.text.j.u0(r8, r9, r10, r11, r12, r13)
            return r1
        L_0x00d8:
        ...
        L_0x00df:
            ...
            r6 = r8
            r8 = r4
            java.util.List r4 = kotlin.text.j.u0(r6, r7, r8, r9, r10, r11)
        ...
        L_0x00f6:
            ...
            r14 = 0
            r11 = r5
            java.util.List r1 = kotlin.text.j.u0(r11, r12, r13, r14, r15, r16)
    ...
    private final void readTheList() throws java.io.IOException {
        /*
            ...
            kotlin.Unit r3 = kotlin.Unit.f12577a     // Catch:{ all -> 0x0044 }
            r3 = 0
            tb.c.a(r0, r3)
            monitor-enter(r4)
            kotlin.jvm.internal.m.c(r1)     // Catch:{ all -> 0x0041 }
            r4.publicSuffixListBytes = r1     // Catch:{ all -> 0x0041 }
            kotlin.jvm.internal.m.c(r2)     // Catch:{ all -> 0x0041 }
    ...
    private final List<String> splitDomain(String str) {
        List<String> u02 = j.u0(str, new char[]{JwtParser.SEPARATOR_CHAR}, false, 0, 6, (Object) null);
        if (m.b((String) r.g0(u02), "")) {
            return r.T(u02, 1);
        }
        return u02;
    }
    ...
    public final String getEffectiveTldPlusOne(String str) {
        ...
        return h.p(h.i(r.Q(splitDomain(str)), size - size2), f.G, (CharSequence) null, (CharSequence) null, 0, (CharSequence) null, (Function1) null, 62, (Object) null);
    }

    public final void setListBytes(byte[] bArr, byte[] bArr2) {
        m.f(bArr, "publicSuffixListBytes");
        m.f(bArr2, "publicSuffixExceptionListBytes");
