...
public class EmojiMetadata {
    ...
    EmojiMetadata(@NonNull MetadataRepo metadataRepo, @IntRange(from = 0) int i10) {
    ...
    public void draw(@NonNull Canvas canvas, float f10, float f11, @NonNull Paint paint) {
        ...
        canvas2.drawText(this.mMetadataRepo.getEmojiCharArray(), this.mIndex * 2, 2, f10, f11, paint);
