...
public class TransitionInflater {
        ...
        while (true) {
            ...
            if (next == 2) {
                if (xmlPullParser.getName().equals("target")) {
                    TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, o.f16692a);
    ...
    private void loadTransition(AttributeSet attributeSet, XmlPullParser xmlPullParser, ViewGroup viewGroup, TransitionManager transitionManager) throws Resources.NotFoundException {
        ...
        TypedArray obtainStyledAttributes = this.mContext.obtainStyledAttributes(attributeSet, o.f16693b);
