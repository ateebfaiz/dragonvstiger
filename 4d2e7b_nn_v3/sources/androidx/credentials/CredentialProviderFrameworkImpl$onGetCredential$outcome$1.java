...
public final class CredentialProviderFrameworkImpl$onGetCredential$outcome$1 implements OutcomeReceiver {
    ...
    CredentialProviderFrameworkImpl$onGetCredential$outcome$1(CredentialManagerCallback<GetCredentialResponse, GetCredentialException> credentialManagerCallback, CredentialProviderFrameworkImpl credentialProviderFrameworkImpl) {
