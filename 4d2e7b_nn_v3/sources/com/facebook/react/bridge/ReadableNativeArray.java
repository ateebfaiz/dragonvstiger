        ...
        synchronized (this) {
            try {
                if (this.mLocalArray == null) {
                    jniPassCounter++;
                    this.mLocalArray = (Object[]) p5.a.c(importArray());
                }
            } catch (Throwable th) {
                while (true) {
                    throw th;
        ...
        synchronized (this) {
            try {
                if (this.mLocalTypeArray == null) {
                    jniPassCounter++;
                    Object[] objArr = (Object[]) p5.a.c(importTypeArray());
        ...
        for (int i10 = 0; i10 < size(); i10++) {
            switch (AnonymousClass1.$SwitchMap$com$facebook$react$bridge$ReadableType[getType(i10).ordinal()]) {
                ...
                case 6:
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Could not convert object at index: " + i10 + f.G);
            }
        }
        return arrayList;
    }
