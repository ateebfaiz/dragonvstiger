...
public class ChipDrawable extends MaterialShapeDrawable implements TintAwareDrawable, Drawable.Callback, TextDrawableHelper.TextDrawableDelegate {
    ...
    private ChipDrawable(@NonNull Context context2, AttributeSet attributeSet, @AttrRes int i10, @StyleRes int i11) {
    ...
    private void calculateChipIconBounds(@NonNull Rect rect, @NonNull RectF rectF2) {
        ...
        if (showsChipIcon() || showsCheckedIcon()) {
            ...
            if (DrawableCompat.getLayoutDirection(this) == 0) {
                ...
                rectF2.left = f11;
                rectF2.right = f11 + currentChipIconWidth;
            } else {
                float f12 = ((float) rect.right) - f10;
                rectF2.right = f12;
                rectF2.left = f12 - currentChipIconWidth;
            }
    ...
    @NonNull
    public static ChipDrawable createFromAttributes(@NonNull Context context2, @Nullable AttributeSet attributeSet, @AttrRes int i10, @StyleRes int i11) {
    ...
    @NonNull
    public static ChipDrawable createFromResource(@NonNull Context context2, @XmlRes int i10) {
    ...
    private float getCurrentChipIconHeight() {
        ...
        if (f10 <= 0.0f && drawable != null) {
            f10 = (float) Math.ceil((double) ViewUtils.dpToPx(this.context, 24));
